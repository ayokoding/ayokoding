...
!(function (e, t) {
  ...
  var n = function (e) {
    ...
    m = function (e, t) {
      if (!p(e)) return e;
      var n, i;
      if (t && 'function' == typeof (n = e.toString) && !p((i = n.call(e))))
        return i;
  ...
  var Q,
    ...
    te = t(function (e) {
      ...
      (e.exports = function (e, t, a, o) {
        var s = !!o && !!o.unsafe,
          ...
          c = !!o && !!o.noTargetGet;
        'function' == typeof a &&
          ('string' != typeof t || b(a, 'name') || P(a, 'name', t),
    ...
    Me = function (e, t) {
      ...
      if ((n = c ? i : u ? i[l] || N(l, {}) : (i[l] || {}).prototype))
        for (r in t) {
          if (
            ((o = t[r]),
            (a = e.noTargetGet ? (s = Ne(n, r)) && s.value : n[r]),
    ...
    Fe = function (e) {
      return (
        b(He, e) ||
          (De && b(Ue, e) ? (He[e] = Ue[e]) : (He[e] = Be('Symbol.' + e))),
        He[e]
      );
    },
    ze = Fe('species'),
    qe = function (e, t) {
      ...
      return (
        Ie(e) &&
          ...
          (n !== Array && !Ie(n.prototype))
            ? p(n) && null === (n = n[ze]) && (n = void 0)
            : (n = void 0)),
  ...
  Me(
    { target: 'Array', proto: !0, forced: !Je || !Qe },
    {
      concat: function (e) {
        var t,
          n,
        ...
        for (t = -1, i = arguments.length; t < i; t++)
          if (((a = -1 === t ? o : arguments[t]), Ze(a))) {
            if (l + (r = ce(a.length)) > 9007199254740991)
    ...
    ct = function (e, t) {
      ...
      return (st[e] =
        ...
        !r(function () {
          if (i && !a) return !0;
          var e = { length: -1 };
          i ? ot(e, 1, { enumerable: !0, get: lt }) : (e[1] = 1),
            n.call(e, o, s);
        }));
    },
    ut = rt.forEach,
  ...
  var vt = rt.map,
    ...
    pt = ct('map');
  Me(
    { target: 'Array', proto: !0, forced: !gt || !pt },
    {
      map: function (e) {
  ...
  var mt =
    ...
    wt =
      ...
      r(function () {
        ...
        ? function (e, t) {
            for (
              var n = Oe(e), i = arguments.length, r = 1, o = we.f, s = l.f;
              i > r;
              ...
              for (
                var c,
                  u = f(arguments[r++]),
                  d = o ? mt(u).concat(o(u)) : mt(u),
                  h = d.length,
                  v = 0;
                h > v;

              )
                (c = d[v++]), (a && !s.call(u, c)) || (n[c] = u[c]);
            return n;
          }
        : yt;
  Me(
    { target: 'Object', stat: !0, forced: Object.assign !== wt },
    { assign: wt }
  );
  var St,
    Et = a
      ...
      : function (e, t) {
          x(e);
          for (var n, i = mt(t), r = i.length, a = 0; r > a; )
            C.f(e, (n = i[a++]), t[n]);
          return e;
        },
  ...
  var Ct =
    ...
    It = {
      f: function (e) {
        return Mt && '[object Window]' == Nt.call(e)
          ? (function (e) {
              try {
                return Pt(e);
              } catch (e) {
    ...
    Ht = function (e, t, n) {
      e &&
        !b((e = n ? e : e.prototype), jt) &&
        Dt(e, jt, { configurable: !0, value: t });
    },
    Ut = rt.forEach,
    Bt = V('hidden'),
    Ft = Fe('toPrimitive'),
    ...
    an = function (e, t) {
      ...
      return (
        zt(n, { type: 'Symbol', tag: e, description: t }),
        a || (n.description = t),
        n
      );
    },
    ...
    sn = function (e, t, n) {
      ...
      return (
        ...
        b(Gt, i)
          ? (n.enumerable
              ? (b(e, Bt) && e[Bt][i] && (e[Bt][i] = !1),
                (n = Ct(n, { enumerable: c(0, !1) })))
              : (b(e, Bt) || $t(e, Bt, c(1, {})), (e[Bt][i] = !0)),
            rn(e, i, n))
          : $t(e, i, n)
      );
    },
    ...
    cn = function (e) {
      var t = m(e, !0),
        n = Yt.call(this, t);
      return (
        !(this === _t && b(Gt, t) && !b(Jt, t)) &&
        (!(n || !b(this, t) || !b(Gt, t) || (b(this, Bt) && this[Bt][t])) || n)
      );
    },
    un = function (e, t) {
      var n = g(e),
      ...
      if (n !== _t || !b(Gt, i) || b(Jt, i)) {
        var r = Kt(n, i);
        return (
          !r || !b(Gt, i) || (b(n, Bt) && n[Bt][i]) || (r.enumerable = !0), r
        );
      }
    },
    dn = function (e) {
  ...
  if (
    (De ||
      (te(
        (Vt = function () {
          ...
          var e =
            ...
            n = function (e) {
              this === _t && n.call(Jt, e),
                b(this, Bt) && b(this[Bt], t) && (this[Bt][t] = !1),
                rn(this, t, c(1, e));
            };
      ...
      a &&
        ($t(Vt.prototype, 'description', {
          configurable: !0,
          get: function () {
            return qt(this).description;
          },
        }),
        te(_t, 'propertyIsEnumerable', cn, { unsafe: !0 }))),
    Me({ global: !0, wrap: !0, forced: !De, sham: !De }, { Symbol: Vt }),
    Ut(mt(en), function (e) {
      !(function (e) {
    ...
    Me(
      { target: 'Object', stat: !0, forced: !De, sham: !a },
      {
        create: function (e, t) {
    ...
    Me(
      ...
      { getOwnPropertyNames: dn, getOwnPropertySymbols: hn }
    ),
    Me(
      {
        target: 'Object',
    ...
    var fn =
      ...
      r(function () {
        var e = Vt();
        return (
          '[null]' != Wt([e]) || '{}' != Wt({ a: e }) || '{}' != Wt(Object(e))
        );
      });
    Me(
      { target: 'JSON', stat: !0, forced: fn },
      {
        stringify: function (e, t, n) {
          for (var i, r = [e], a = 1; arguments.length > a; )
            r.push(arguments[a++]);
          if (((i = t), (p(t) || void 0 !== e) && !on(e)))
            return (
              Ie(t) ||
                (t = function (e, t) {
                  if (
                    ('function' == typeof i && (t = i.call(this, e, t)), !on(t))
                  )
                    return t;
                }),
              (r[1] = t),
  ...
  Vt.prototype[Ft] || P(Vt.prototype, Ft, Vt.prototype.valueOf),
    Ht(Vt, 'Symbol'),
    (W[Bt] = !0);
  var vn = C.f,
    gn = i.Symbol;
  if (
    a &&
    'function' == typeof gn &&
    (!('description' in gn.prototype) || void 0 !== gn().description)
  ) {
    var pn = {},
      mn = function () {
        var e =
    ...
    Mn = Cn
      ...
      : function (e) {
          ...
          return void 0 === e
            ...
            : Nn
            ? d(t)
            : 'Object' == (i = d(t)) && 'function' == typeof t.callee
            ? 'Arguments'
            : i;
        },
    In = Fe('iterator'),
    ...
    { target: 'Array', stat: !0, forced: Bn },
    {
      from: function (e) {
        var t,
          ...
          f = 0;
        if (
          (d && (u = tt(u, c > 2 ? arguments[2] : void 0, 2)),
          null == h || (l == Array && xn(h)))
        )
          for (n = new l((t = ce(s.length))); t > f; f++)
            (o = d ? u(s[f], f) : s[f]), Te(n, f, o);
        else
          for (
            ...
            (o = d ? En(r, u, [i.value, f], !0) : i.value), Te(n, f, o);
        return (n.length = f), n;
      },
    }
  );
  ...
  Me(
    { target: 'Array', proto: !0, forced: qn || !_n || !Vn },
    {
      indexOf: function (e) {
        return qn
          ? zn.apply(this, arguments) || 0
          : Fn(this, e, arguments.length > 1 ? arguments[1] : void 0);
      },
    }
  );
  var Wn = Ye('splice'),
    Kn = ct('splice', { ACCESSORS: !0, 0: 0, 1: 2 }),
    $n = Math.max,
    Xn = Math.min;
  Me(
    { target: 'Array', proto: !0, forced: !Wn || !Kn },
    {
      splice: function (e, t) {
        var n,
          i,
        ...
        if (
          (0 === d
            ...
            : 1 === d
            ? ((n = 0), (i = c - u))
            : ((n = d - 2), (i = Xn($n(se(t), 0), c - u))),
          c + n - i > 9007199254740991)
        )
          throw TypeError('Maximum allowed length exceeded');
        for (r = qe(l, i), a = 0; a < i; a++)
          (o = u + a) in l && Te(r, a, l[o]);
        if (((r.length = i), n < i)) {
          for (a = u; a < c - i; a++)
  ...
  var Zn =
    ...
    ai = function (e) {
      return function (t) {
        var n = String(v(t));
        return (
          1 & e && (n = n.replace(ii, '')), 2 & e && (n = n.replace(ri, '')), n
        );
      };
    },
    oi = { start: ai(1), end: ai(2), trim: ai(3) },
    si = be.f,
    li = R.f,
    ci = C.f,
    ui = oi.trim,
  ...
  if (Pe('Number', !di(' 0o1') || !di('0b1') || di('+0x1'))) {
    for (
      ...
      b(di, (gi = mi[yi])) && !b(pi, gi) && ci(pi, gi, li(di, gi));
    ...
    Ri = t(function (e) {
      ...
      (e.exports = function (e, n, i, r, a) {
        ...
        if (a) o = e;
          ...
          if ('function' != typeof (s = On(e)))
            throw TypeError('Target is not iterable');
          if (xn(s)) {
            for (l = 0, c = ce(e.length); c > l; l++)
              if (
                (u = r ? f(x((h = e[l]))[0], h[1]) : f(e[l])) &&
                u instanceof t
              )
                return u;
            return new t(!1);
        ...
        for (d = o.next; !(h = d.call(o)).done; )
          if (
            'object' == typeof (u = En(o, f, h.value, r)) &&
            u &&
            u instanceof t
          )
            return u;
  ...
  ir ||
    ...
    tr
      ...
      ? ((Wi = !0),
        ...
        new Qi(zi).observe(Ki, { characterData: !0 }),
        (Vi = function () {
          Ki.data = Wi = !Wi;
        }))
      : er && er.resolve
  ...
  var rr,
    ...
    Cr = Pe(gr, function () {
      ...
      return (
        ((e.constructor = {})[vr] = t), !(e.then(function () {}) instanceof t)
      );
    }),
    Pr =
      Cr ||
      ...
      if (!t.notified) {
        ...
        lr(function () {
          for (var r = t.value, a = 1 == t.state, o = 0; i.length > o; ) {
            ...
            try {
              d
                ? (a || (2 === t.rejection && Dr(e, t), (t.rejection = 1)),
                  !0 === d
                    ? (s = r)
                    : (v && v.enter(), (s = d(r)), v && (v.exit(), (c = !0))),
                  s === u.promise
                    ? f(wr('Promise-chain cycle'))
                    : (l = Nr(s))
                    ? l.call(s, h, f)
                    : h(s))
                : f(r);
    ...
    Ir = function (e, t, n) {
      var r, a;
      Lr
        ? (((r = Sr.createEvent('Event')).promise = t),
          (r.reason = n),
          r.initEvent(e, !1, !0),
          i.dispatchEvent(r))
    ...
    Or = function (e, t) {
      fr.call(i, function () {
        ...
        if (
          ...
          ((n = hr(function () {
            xr
              ? Er.emit('unhandledRejection', i, e)
              : Ir('unhandledrejection', e, i);
          })),
          (t.rejection = xr || Tr(t) ? 2 : 1),
          n.error)
        )
          throw n.value;
      });
    ...
    Dr = function (e, t) {
      fr.call(i, function () {
        xr
          ? Er.emit('rejectionHandled', e)
          : Ir('rejectionhandled', e, t.value);
      });
    },
    jr = function (e, t, n, i) {
      return function (r) {
  ...
  Cr &&
    ...
    ((rr = function (e) {
      ...
      then: function (e, t) {
        ...
        return (
          ...
          (i.domain = xr ? Er.domain : void 0),
          (n.parent = !0),
          n.reactions.push(i),
          0 != n.state && Mr(this, n, !1),
          i.promise
        );
      },
      catch: function (e) {
    ...
    (ar = function () {
      var e = new rr(),
        t = pr(e);
      (this.promise = e),
        (this.resolve = jr(Ur, e, t)),
        (this.reject = jr(Hr, e, t));
    }),
    (ur.f = Ar =
      function (e) {
    ...
    Me({ global: !0, wrap: !0, forced: Cr }, { Promise: br }),
    Ht(br, gr, !1),
    (function (e) {
      var t = re(e),
        n = C.f;
      ...
      return (
        ...
        o
          ? i
            ...
            : (a.lastIndex = 0)
          : $r && i && (a.lastIndex = a.global ? i.index + i[0].length : t),
        Yr &&
          i &&
          i.length > 1 &&
          Wr.call(i[0], n, function () {
  ...
  [].keys &&
    ('next' in (Zr = [].keys())
      ? (Qr = aa(aa(Zr))) !== Object.prototype && (Jr = Qr)
      : (sa = !0)),
    null == Jr && (Jr = {}),
    b(Jr, oa) ||
      P(Jr, oa, function () {
  ...
  var la = { IteratorPrototype: Jr, BUGGY_SAFARI_ITERATORS: sa },
  ...
  !(function (e, t, n, i, r, a, o) {
    ...
    if (
      (m &&
        ...
        da !== Object.prototype &&
          s.next &&
          (aa(s) !== da &&
            (Zn ? Zn(s, da) : 'function' != typeof s[fa] && P(s, fa, va)),
          Ht(s, h, !0))),
      'values' == r &&
        g &&
        'values' !== g.name &&
      ...
      else Me({ target: t, proto: !0, forced: ha || f }, l);
  })(
    String,
    'String',
    function (e) {
    ...
    function () {
      ...
      return i >= n.length
        ? { value: void 0, done: !0 }
        : ((e = ga(n, i)), (t.index += e.length), { value: e, done: !1 });
    }
  );
  var ya = Fe('species'),
    ba = !r(function () {
    ...
    return [
      ...
      function (e) {
        ...
        for (var s, l = [], c = 0; null !== (s = La(r, a)); ) {
          var u = String(s[0]);
          (l[c] = u),
            '' === u && (r.lastIndex = xa(a, ce(r.lastIndex), o)),
            c++;
        }
        return 0 === c ? null : l;
      },
          ...
          ''.split(/.?/).length
            ? function (e, n) {
                ...
                for (
                  ...
                  !(
                    (l = g.lastIndex) > f &&
                    (u.push(a.slice(f, s.index)),
                    s.length > 1 &&
                      s.index < a.length &&
                      Pa.apply(u, s.slice(1)),
                    (c = s[0].length),
                    (f = l),
                    u.length >= o)
                  );
        ...
        [
          ...
          function (e, r) {
            ...
            for (var f = 0, v = 0, g = []; v < s.length; ) {
              d.lastIndex = Ma ? v : 0;
              var p,
                m = La(d, Ma ? s : s.slice(v));
              if (
                null === m ||
                (p = Na(ce(d.lastIndex + (Ma ? 0 : v)), s.length)) === f
              )
                v = xa(s, v, c);
              else {
  ...
  Aa('search', 1, function (e, t, n) {
    return [
      ...
      function (e) {
        ...
        var s = La(r, a);
        return (
          Za(r.lastIndex, o) || (r.lastIndex = o), null === s ? -1 : s.index
        );
      },
    ];
  });
  var eo = function (e, t) {
    ...
    vo =
      /(iphone|ipod|ipad|android)/gi.test(ho) ||
      ('MacIntel' === navigator.platform && navigator.maxTouchPoints > 1),
    go = /chrome/i.test(ho) && !/edge/i.test(ho),
    po = /android/gi.test(ho),
    mo =
      'zoom' in fo.style && !vo && (go || /Version\/[\d\.]+.*Safari/.test(ho)),
    yo =
      'function' == typeof window.history.replaceState && !/PhantomJS/.test(ho),
    bo = (function () {
      function e(t) {
        Ua(this, e),
          (this.Reveal = t),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              t &&
                ...
                to(t, 'iframe[src]').forEach(function (e) {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              e &&
                ...
                (to(e, 'img[src$=".gif"]').forEach(function (e) {
                ...
                to(e, 'iframe[src]').forEach(function (e) {
                  (oo(e, '.fragment') && !oo(e, '.fragment.visible')) ||
            ...
            value: function (e) {
              ...
              (n = eo({ unloadIframes: !0 }, n)),
                e &&
                  ...
                  to(e, 'iframe[src*="youtube.com/embed/"]').forEach(function (
                    e
                  ) {
                    !e.hasAttribute('data-ignore') &&
                      e.contentWindow &&
                  ...
                  to(e, 'iframe[src*="player.vimeo.com/"]').forEach(function (
                    e
                  ) {
                    !e.hasAttribute('data-ignore') &&
                      e.contentWindow &&
            ...
            value: function () {
              ...
              if ('function' == typeof n.slideNumber) e = n.slideNumber(t);
                ...
                switch (
                  ...
                  case 'c/t':
                    e.push(
                      this.Reveal.getSlidePastCount(t) + 1,
                      '/',
              ...
              if (
                (Array.from(this.element.childNodes).forEach(function (e, n) {
                  e.classList.remove('past', 'present', 'future'),
                    ...
                    (t || n === i.h) &&
                      to(e, '.slide-background').forEach(function (e, t) {
                        e.classList.remove('past', 'present', 'future'),
                          t < i.v
    ...
    Ro = ct('filter');
  Me(
    { target: 'Array', proto: !0, forced: !Ao || !Ro },
    {
      filter: function (e) {
  ...
  var xo = [].join,
    ...
    Co = at('join', ',');
  Me(
    { target: 'Array', proto: !0, forced: Lo || !Co },
    {
      join: function (e) {
  ...
  var Po = function (e) {
    ...
    No = { left: Po(!1), right: Po(!0) }.left,
    Mo = at('reduce'),
    Io = ct('reduce', { 1: 0 });
  Me(
    { target: 'Array', proto: !0, forced: !Mo || !Io },
    {
      reduce: function (e) {
        return No(
          this,
  ...
  var Oo = Ye('slice'),
    To = ct('slice', { ACCESSORS: !0, 0: 0, 1: 2 }),
    Do = Fe('species'),
    jo = [].slice,
    Ho = Math.max;
  Me(
    { target: 'Array', proto: !0, forced: !Oo || !To },
    {
      slice: function (e, t) {
        ...
        if (
          ...
          (n !== Array && !Ie(n.prototype))
            ? p(n) && null === (n = n[Do]) && (n = void 0)
            : (n = void 0),
          n === Array || void 0 === n)
        )
          return jo.call(a, s, l);
        for (
          i = new (void 0 === n ? Array : n)(Ho(l - s, 0)), r = 0;
          s < l;
          s++, r++
        )
          s in a && Te(i, r, a[s]);
  ...
  Me(
    { target: 'Object', stat: !0, forced: Uo },
    {
      keys: function (e) {
        return mt(Oe(e));
      },
  ...
  var Bo = 0,
            ...
            value: function (e, t, n, i, r) {
              ...
              t.classList.contains('fragment') &&
                ...
                e.classList.contains('fragment') &&
                  (e.className.match($a) || [''])[0] ===
                    (t.className.match($a) || [''])[0] &&
      ...
      return (
        Fa(e, [
          ...
          },
          {
            key: 'disable',
            value: function () {
              to(this.Reveal.getSlidesElement(), '.fragment').forEach(function (
                e
              ) {
            ...
            value: function () {
              ...
              if (this.Reveal.getConfig().overview && !this.isActive()) {
                (this.active = !0),
                  ...
                  to(this.Reveal.getRevealElement(), '.slides section').forEach(
                    function (t) {
            ...
            value: function () {
              ...
              this.Reveal.getHorizontalSlides().forEach(function (t, n) {
                t.setAttribute('data-index-h', n),
                  ...
                  t.classList.contains('stack') &&
                    to(t, 'section').forEach(function (t, i) {
                      t.setAttribute('data-index-h', n),
                ...
                Array.from(
                  ...
                  ro(
                    ...
                    to(t, '.slide-background').forEach(function (t, n) {
                      ro(
                        t,
        ...
        Fa(e, [
          {
            ...
            value: function () {
              ...
              (this.element = document.createElement('aside')),
                ...
                this.Reveal.getRevealElement().appendChild(this.element),
                (this.controlsLeft = to(t, '.navigate-left')),
                (this.controlsRight = to(t, '.navigate-right')),
                (this.controlsUp = to(t, '.navigate-up')),
                (this.controlsDown = to(t, '.navigate-down')),
                (this.controlsPrev = to(t, '.navigate-prev')),
                (this.controlsNext = to(t, '.navigate-next')),
          ...
          },
          {
            ...
            value: function () {
              ...
              []
                .concat(
                  Va(this.controlsLeft),
                  Va(this.controlsRight),
                  Va(this.controlsUp),
                  Va(this.controlsDown),
                  Va(this.controlsPrev),
                  Va(this.controlsNext)
                )
                .forEach(function (e) {
            ...
            value: function () {
              this.Reveal.getConfig().progress &&
                ...
                (this.bar.style.transform =
                  'scaleX(' + this.Reveal.getProgress() + ')');
            },
          },
          {
            key: 'getMaxWidth',
    ...
    Yo = function (e) {
      return function (t) {
        for (var n, i = g(t), r = mt(i), o = r.length, s = 0, l = []; o > s; )
          (n = r[s++]), (a && !Xo.call(i, n)) || l.push(e ? [n, i[n]] : i[n]);
        return l;
      };
    },
        ...
        Fa(e, [
          {
            ...
            value: function () {
              var e = this.Reveal.getConfig(),
                ...
                r = t.width,
                a = t.height;
              lo('@page{size:' + n + 'px ' + i + 'px; margin: 0px;}'),
                lo(
                ...
                to(this.Reveal.getRevealElement(), '.slides section').forEach(
                  function (t) {
                    if (!1 === t.classList.contains('stack')) {
                      ...
                      ((1 === (u = Math.min(u, e.pdfMaxPagesPerSlide)) &&
                        e.center) ||
                      ...
                      if (e.pdfSeparateFragments) {
                        ...
                        to(d, '.fragment:not(.fade-out)').forEach(function (e) {
                          e.classList.add('visible');
                        });
                    }
                  },
  ...
  function ss(e, t) {
    ...
    function j(n) {
      return (
        ...
        (l = _a(_a(_a(_a(_a({}, os), l), t), n), co())),
        H(),
        window.addEventListener('load', ae, !1),
    ...
    function H() {
      !0 === l.embedded
        ? (v.viewport = oo(e, '.reveal-viewport') || e)
    ...
    function W(e) {
      ...
      if (('object' === Ha(e) && eo(l, e), !1 !== s.isReady())) {
        ...
        v.wrapper.classList.remove(t.transition),
          ...
          l.shuffle && Ae(),
          no(v.wrapper, 'embedded', l.embedded),
          no(v.wrapper, 'rtl', l.rtl),
          no(v.wrapper, 'center', l.center),
          !1 === l.pause && ge(),
          l.previewLinks
    ...
    function G(e) {
      'string' == typeof e.layout && (f.layout = e.layout),
        ...
        f.layout
          ? ro(v.slides, f.layout + ' ' + f.overview)
          : ro(v.slides, f.overview);
    }
    function J(e) {
      var t = e.target,
    ...
    function ee() {
      ...
      Array.from(v.wrapper.querySelectorAll(e)).forEach(function (e) {
        /^(http|www)/gi.test(e.getAttribute('href')) &&
          e.removeEventListener('click', it, !1);
      });
    }
    function te(e) {
      re(),
    ...
    function ae() {
      if (v.wrapper && !I.isPrintingPDF()) {
        if (!l.disableLayout) {
          ...
          oe(l.width, l.height),
            ...
            1 === (h = Math.min(h, l.maxScale))
              ? ((v.slides.style.zoom = ''),
                ...
                G({ layout: '' }))
              : h > 1 && mo && window.devicePixelRatio < 2
          ...
          for (
            var n = Array.from(v.wrapper.querySelectorAll('.slides section')),
              i = 0,
              r = n.length;
            i < r;
            i++
    ...
    function oe(e, t) {
      to(v.slides, 'section > .stretch, section > .r-stretch').forEach(
        function (n) {
          var i = uo(n, t);
    ...
    function fe() {
      return (
        ...
        (!ue(a) || !a.parentNode.nextElementSibling)
      );
    }
    function ve() {
      if (l.pause) {
    ...
    function we(e, t, o, s) {
      ...
      if (0 !== c.length) {
        ...
        var h = n || 0,
          f = i || 0;
        (n = Re('.slides>section', void 0 === e ? n : e)),
          (i = Re('.slides>section.present>section', void 0 === t ? i : t));
        var p = n !== h || i !== f;
        p || (r = null);
        var m = c[n],
    ...
    function Re(e, t) {
      ...
      if (i) {
          ...
          o.classList.remove('past'),
            ...
            r
              ...
              ? (o.classList.add(s ? 'future' : 'past'),
                l.fragments &&
                  to(o, '.fragment').forEach(function (e) {
                    e.classList.add('visible'),
                      e.classList.remove('current-fragment');
                  }))
              : a > t &&
                ...
                l.fragments &&
                  to(o, '.fragment.visible').forEach(function (e) {
                    e.classList.remove('visible', 'current-fragment');
                  }));
        }
        var c = n[t],
        ...
        c.classList.add('present'),
          ...
          u || J({ target: c, type: 'visible', bubbles: !1 });
    ...
    function xe() {
      ...
      if (r && void 0 !== n) {
        ...
        vo && (a = R.isActive() ? 6 : l.mobileViewDistance),
    ...
    function Ne(e) {
      ...
      if (e) {
        ...
        (r = Math.max(c.indexOf(l), 0)),
          (o = void 0),
          s && (o = Math.max(to(e.parentNode, 'section').indexOf(e), 0));
      }
        ...
        t
          ...
          : ((p = l.autoSlide),
            0 === a.querySelectorAll('.fragment').length &&
              to(a, 'video, audio').forEach(function (e) {
                e.hasAttribute('data-autoplay') &&
                  p &&
          ...
          !p ||
            ...
            me() ||
            R.isActive() ||
            (fe() && !A.availableRoutes().next && !0 !== l.loop) ||
    ...
    function $e() {
      (u.hasNavigatedHorizontally = !0),
        l.rtl
          ? (R.isActive() || !1 === A.next()) &&
            Le().left &&
            we(n + 1, 'grid' === l.navigationMode ? i : void 0)
          : (R.isActive() || !1 === A.prev()) &&
            Le().left &&
            we(n - 1, 'grid' === l.navigationMode ? i : void 0);
    }
    ...
    function Ge() {
      (u.hasNavigatedVertically = !0),
        (R.isActive() || !1 === A.next()) && Le().down && we(n, i + 1);
    }
    function Je() {
      var e;
      if (!1 === A.prev())
        if (Le().up) Ye();
          ...
          (e = l.rtl
            ? to(v.wrapper, '.slides>section.future').pop()
            : to(v.wrapper, '.slides>section.past').pop())
        ) {
    ...
    function Qe() {
      if (
        ...
        var e = Le();
        e.down && e.right && l.loop && de() && (e.down = !1),
          e.down ? Ge() : l.rtl ? $e() : Xe();
      }
    }
    function Ze(e) {
  ...
  var ls = ss,
    cs = [];
  return (
    (ls.initialize = function (e) {
      return (
        Object.assign(ls, new ss(document.querySelector('.reveal'), e)),
        cs.map(function (e) {
          return e(ls);
        }),
        ls.initialize()
