...
(function (O, pa) {
  ...
  function Eb(a, b, c) {
    ...
    c.isMergeableObject(a) &&
      Ta(a).forEach(function (e) {
        d[e] = O(a[e], c);
      });
    Ta(b).forEach(function (e) {
      if (
        !Ua(a, e) ||
        (Object.hasOwnProperty.call(a, e) &&
          Object.propertyIsEnumerable.call(a, e))
      )
        if (Ua(a, e) && c.isMergeableObject(b[e])) {
          if (c.customMerge) {
            var f = c.customMerge(e);
            f = 'function' === typeof f ? f : da;
          } else f = da;
          d[e] = f(a[e], b[e], c);
        } else d[e] = O(b[e], c);
    });
  ...
  function Xb(a, b) {
    ...
    b.isCentered() ? (c = Wb(b)) : (c.placement = a.on);
    (a = b.tour && b.tour.options && b.tour.options.defaultStepOptions) &&
      (c = kb(a, c));
    return (c = kb(b.options, c));
  }
  function kb(a, b) {
    if (a.popperOptions) {
  ...
  function sb(a) {
    let b, c;
    b = new bc({ props: { config: a[2], step: a[0] } });
    return {
      c() {
        ca(b.$$.fragment);
      },
  ...
  function tb(a) {
    let b, c;
    b = new ic({ props: { labelId: a[0], title: a[2] } });
    return {
      c() {
        ca(b.$$.fragment);
      },
  ...
  function ub(a) {
    let b, c;
    b = new jc({ props: { cancelIcon: a[3], step: a[1] } });
    return {
      c() {
        ca(b.$$.fragment);
      },
  ...
  function vb(a) {
    let b, c;
    b = new oc({ props: { labelId: a[1], step: a[2] } });
    return {
      c() {
        ca(b.$$.fragment);
      },
  ...
  function wb(a) {
    let b, c;
    b = new pc({ props: { descriptionId: a[0], step: a[2] } });
    return {
      c() {
        ca(b.$$.fragment);
      },
  ...
  function tc(a) {
    let b,
      ...
      k =
        ...
        yb();
    d = new uc({ props: { descriptionId: a[2], labelId: a[3], step: a[4] } });
    let p = [
        {
      ...
      q = {};
    for (let n = 0; n < p.length; n += 1) q = Yb(q, p[n]);
    return {
      c() {
        b = document.createElement('div');
        k && k.c();
...
Z`)
  ...
  var ua = ['top', 'bottom', 'right', 'left'],
    fb = ua.reduce(function (a, b) {
      return a.concat([b + '-start', b + '-end']);
    }, []),
    eb = [].concat(ua, ['auto']).reduce(function (a, b) {
            ...
            if (f && g) {
              ...
              e =
                'function' === typeof e
                  ...
                  : e;
              e = Ya('number' !== typeof e ? e : Za(e, ua));
              var m = Fa(f),
                k = 'y' === a ? 'top' : 'left',
                p = 'y' === a ? 'bottom' : 'right',
                q =
          ...
          effect: function (a) {
            ...
            if (null != a) {
              if (
                ...
                return;
              Wa(b.elements.popper, a) && (b.elements.arrow = a);
            }
          },
          requires: ['popperOffsets'],
  ...
  class bc extends T {
    constructor(a) {
      super();
      S(this, a, ac, $b, Q, { config: 6, step: 7 });
    }
  }
  class qc extends T {
    constructor(a) {
      super();
      S(this, a, dc, cc, Q, { step: 0 });
    }
  }
  class jc extends T {
    constructor(a) {
      super();
      S(this, a, fc, ec, Q, { cancelIcon: 0, step: 2 });
    }
  }
  class ic extends T {
    constructor(a) {
      super();
      S(this, a, hc, gc, Q, { labelId: 1, element: 0, title: 2 });
    }
  }
  class oc extends T {
    constructor(a) {
      super();
      S(this, a, lc, kc, Q, { labelId: 0, step: 1 });
    }
  }
  class pc extends T {
    constructor(a) {
      super();
      S(this, a, nc, mc, Q, { descriptionId: 1, element: 0, step: 2 });
    }
  }
  class uc extends T {
    constructor(a) {
      super();
      S(this, a, sc, rc, Q, { descriptionId: 0, labelId: 1, step: 2 });
    }
  }
  class Cc extends T {
    constructor(a) {
  ...
  class Sa extends Ra {
    ...
    show() {
      if (ea(this.options.beforeShowPromise)) {
    ...
    _createTooltipContent() {
      this.shepherdElementComponent = new Cc({
    ...
    _scrollTo(a) {
      let { element: b } = Ma(this);
      ea(this.options.scrollToHandler)
    ...
    _setOptions(a) {
      ...
      this.destroy();
      this.id = this.options.id || `step-${Na()}`;
      c &&
  ...
  class Ec extends Ra {
    ...
    addStep(a, b) {
      a instanceof Sa ? (a.tour = this) : (a = new Sa(this, a));
    ...
    show(a, b) {
      ...
      if ((a = qa(a) ? this.getById(a) : this.steps[a]))
        this._updateStateBeforeShow(),
          ea(a.options.showOn) && !a.options.showOn()
            ? this._skipStep(a, b)
    ...
    _skipStep(a, b) {
      ...
      a = b ? a + 1 : a - 1;
      a === this.steps.length - 1 ? this.complete() : this.show(a, b);
    }
    ...
    _setTourID() {
      this.id = `${this.options.tourName || 'tour'}--${Na()}`;
    }
  }
  Object.assign(oa, { Tour: Ec, Step: Sa });
  return oa;
});
