  ...
  return (function () {
    ...
    var it = function (e) {
      ...
      dt = function (e) {
        return e instanceof M ||
          e instanceof q ||
          (e instanceof N && e.hasClass('enclosing'))
          ? e
          : null;
      },
      ft = function e(t, r) {
    ...
    var Ut = function (e, t) {
        ...
        if (n.isStretchy)
          ...
          var u, p;
          '\\vec' === n.label
            ? ((u = je.staticSvg('vec', t)), (p = je.svgData.vec[1]))
            : (((u = L(
                (u = je.makeOrd({ mode: n.mode, text: n.label }, t, 'textord'))
              )).italic = 0),
              (p = u.width),
              m && (c += u.depth)),
            (h = je.makeSpan(['accent-body'], [u]));
    ...
    var Fr = function (e, t) {
        ...
        for (a = 0, q = 0; a < s || q < I.length; ++a, ++q) {
          for (var D = I[q] || {}, P = !0; 'separator' === D.type; ) {
            if (
              (P ||
                (((N = je.makeSpan(['arraycolsep'], [])).style.width =
          ...
          if (!(a >= s)) {
            ...
            (a > 0 || e.hskipBeforeAndAfter) &&
              ...
              (((N = je.makeSpan(['arraycolsep'], [])).style.width = G + 'em'),
              R.push(N));
            var U = [];
            for (r = 0; r < i; ++r) {
              var Y = h[r],
      ...
      Gr = function (e, t) {
        for (
          ...
          for (var o = e.body[i], s = [], l = 0; l < o.length; l++)
            s.push(new Mt.MathNode('mtd', [qt(o[l], t)]));
          e.addEqnNum &&
    ...
    nt({
      ...
      dn('\\operatorname', '\\@ifstar\\operatornamewithlimits\\operatorname@'),
      at({
        type: 'ordgroup',
        htmlBuilder: function (e, t) {
          return e.semisimple
      ...
      nt({
        ...
        mathmlBuilder: function (e, t) {
          var r = e.body,
            n = e.index;
          return n
            ? new Mt.MathNode('mroot', [qt(r, t), qt(n, t)])
            : new Mt.MathNode('msqrt', [qt(r, t)]);
        },
      });
    var bn = {
      display: b.DISPLAY,
    ...
    at({
      ...
      mathmlBuilder: function (e, t) {
        ...
        var a,
          i = [qt(e.base, t)];
        if ((e.sub && i.push(qt(e.sub, t)), e.sup && i.push(qt(e.sup, t)), n))
          a = r ? 'mover' : 'munder';
        else if (e.sub)
          if (e.sup) {
            var o = e.base;
      ...
      at({
        ...
        mathmlBuilder: function (e, t) {
          ...
          return (
            ...
            a !== xn[r.type] && r.setAttribute('mathvariant', a),
            r
          );
        },
      });
    ...
    at({
      ...
      htmlBuilder: function (e, t) {
        ...
        if (wn.hasOwnProperty(e.text))
          return je.makeSpan(['mspace', wn[e.text]], [], t);
    ...
    at({
      ...
      mathmlBuilder: function (e, t) {
        var r = new Mt.MathNode('mtable', [
          new Mt.MathNode('mtr', [
            Sn(),
            new Mt.MathNode('mtd', [Nt(e.body, t)]),
            Sn(),
            new Mt.MathNode('mtd', [Nt(e.tag, t)]),
          ]),
        ]);
    ...
    var Mn = {
      ...
      zn = { '\\textbf': 'textbf', '\\textmd': 'textmd' },
      An = { '\\textit': 'textit', '\\textup': 'textup' },
      Tn = function (e, t) {
        var r = e.font;
        return r
          ? Mn[r]
            ? t.withTextFontFamily(Mn[r])
            : zn[r]
            ? t.withTextFontWeight(zn[r])
    ...
    nt({
      ...
      nt({
        ...
        htmlBuilder: function (e, t) {
          for (
            var r = Bn(e), n = [], a = t.havingStyle(t.style.text()), i = 0;
            i < r.length;
            i++
          ) {
            var o = r[i];
    ...
    dn('\\noexpand', function (e) {
      ...
      dn('\\@ifstar', '\\@ifnextchar *{\\@firstoftwo{#1}}'),
      dn('\\TextOrMath', function (e) {
    ...
    dn('\\char', function (e) {
      ...
      if (t) {
        if (null == (a = Hn[r.text]) || a >= t)
          throw new n('Invalid base-' + t + ' digit ' + r.text);
        for (var i; null != (i = Hn[e.future().text]) && i < t; )
          (a *= t), (a += i), e.popToken();
      }
      return '\\@char{' + a + '}';
    });
    ...
    dn('\\newcommand', function (e) {
      ...
      dn('\\aa', '\\r a'),
      dn('\\AA', '\\r A'),
      dn('\\textcopyright', '\\html@mathml{\\textcircled{c}}{\\char`\xa9}'),
      dn(
        '\\copyright',
      ...
      dn('\\Bbbk', '\\Bbb{k}'),
      dn('\xb7', '\\cdotp'),
      dn('\\llap', '\\mathllap{\\textrm{#1}}'),
      dn('\\rlap', '\\mathrlap{\\textrm{#1}}'),
      dn('\\clap', '\\mathclap{\\textrm{#1}}'),
      dn('\\mathstrut', '\\vphantom{(}'),
      dn('\\underbar', '\\underline{\\text{#1}}'),
      ...
      dn('\u231f', '\\lrcorner'),
      dn('\xa9', '\\copyright'),
      dn('\xae', '\\textregistered'),
      dn('\ufe0f', '\\textregistered'),
      dn('\\ulcorner', '\\html@mathml{\\@ulcorner}{\\mathop{\\char"231c}}'),
      dn('\\urcorner', '\\html@mathml{\\@urcorner}{\\mathop{\\char"231d}}'),
      dn('\\llcorner', '\\html@mathml{\\@llcorner}{\\mathop{\\char"231e}}'),
      dn('\\lrcorner', '\\html@mathml{\\@lrcorner}{\\mathop{\\char"231f}}'),
      dn('\\vdots', '\\mathord{\\varvdots\\rule{0pt}{15pt}}'),
      dn('\u22ee', '\\vdots'),
      dn('\\varGamma', '\\mathit{\\Gamma}'),
      dn('\\varDelta', '\\mathit{\\Delta}'),
      dn('\\varTheta', '\\mathit{\\Theta}'),
      dn('\\varLambda', '\\mathit{\\Lambda}'),
      dn('\\varXi', '\\mathit{\\Xi}'),
      dn('\\varPi', '\\mathit{\\Pi}'),
      dn('\\varSigma', '\\mathit{\\Sigma}'),
      dn('\\varUpsilon', '\\mathit{\\Upsilon}'),
      dn('\\varPhi', '\\mathit{\\Phi}'),
      dn('\\varPsi', '\\mathit{\\Psi}'),
      dn('\\varOmega', '\\mathit{\\Omega}'),
      dn('\\substack', '\\begin{subarray}{c}#1\\end{subarray}'),
      dn(
        '\\colon',
        '\\nobreak\\mskip2mu\\mathpunct{}\\mathchoice{\\mkern-3mu}{\\mkern-3mu}{}{}{:}\\mskip6mu'
      ),
      dn('\\boxed', '\\fbox{$\\displaystyle{#1}$}'),
      dn('\\iff', '\\DOTSB\\;\\Longleftrightarrow\\;'),
      dn('\\implies', '\\DOTSB\\;\\Longrightarrow\\;'),
      dn('\\impliedby', '\\DOTSB\\;\\Longleftarrow\\;');
    var Dn = {
      ',': '\\dotsc',
      '\\not': '\\dotsb',
      '+': '\\dotsb',
    ...
    dn('\\dotso', function (e) {
      ...
      dn('\\DOTSB', '\\relax'),
      dn('\\DOTSX', '\\relax'),
      dn('\\tmspace', '\\TextOrMath{\\kern#1#3}{\\mskip#1#2}\\relax'),
      dn('\\,', '\\tmspace+{3mu}{.1667em}'),
      dn('\\thinspace', '\\,'),
      dn('\\>', '\\mskip{4mu}'),
      dn('\\:', '\\tmspace+{4mu}{.2222em}'),
      dn('\\medspace', '\\:'),
      dn('\\;', '\\tmspace+{5mu}{.2777em}'),
      dn('\\thickspace', '\\;'),
      dn('\\!', '\\tmspace-{3mu}{.1667em}'),
      dn('\\negthinspace', '\\!'),
      ...
      dn('\\enspace', '\\kern.5em '),
      dn('\\enskip', '\\hskip.5em\\relax'),
      dn('\\quad', '\\hskip1em\\relax'),
      dn('\\qquad', '\\hskip2em\\relax'),
      dn('\\tag', '\\@ifstar\\tag@literal\\tag@paren'),
      dn('\\tag@paren', '\\tag@literal{({#1})}'),
      dn('\\tag@literal', function (e) {
    ...
    dn(
      ...
      dn('\\hspace', '\\@ifstar\\@hspacer\\@hspace'),
      dn('\\@hspace', '\\hskip #1\\relax'),
      dn('\\@hspacer', '\\rule{0pt}{0pt}\\hskip #1\\relax'),
      dn('\\ordinarycolon', ':'),
      dn('\\vcentcolon', '\\mathrel{\\mathop\\ordinarycolon}'),
      dn(
        '\\dblcolon',
      ...
      dn('\u2a74', '\\Coloneqq'),
      dn('\\ratio', '\\vcentcolon'),
      dn('\\coloncolon', '\\dblcolon'),
      dn('\\colonequals', '\\coloneqq'),
      dn('\\coloncolonequals', '\\Coloneqq'),
      dn('\\equalscolon', '\\eqqcolon'),
      dn('\\equalscoloncolon', '\\Eqqcolon'),
      dn('\\colonminus', '\\coloneq'),
      dn('\\coloncolonminus', '\\Coloneq'),
      dn('\\minuscolon', '\\eqcolon'),
      dn('\\minuscoloncolon', '\\Eqcolon'),
      dn('\\coloncolonapprox', '\\Colonapprox'),
      dn('\\coloncolonsim', '\\Colonsim'),
      dn('\\simcolon', '\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\vcentcolon}'),
      dn(
        '\\simcoloncolon',
      ...
      dn('\\notni', '\\html@mathml{\\not\\ni}{\\mathrel{\\char`\u220c}}'),
      dn('\\limsup', '\\DOTSB\\operatorname*{lim\\,sup}'),
      dn('\\liminf', '\\DOTSB\\operatorname*{lim\\,inf}'),
      dn('\\injlim', '\\DOTSB\\operatorname*{inj\\,lim}'),
      dn('\\projlim', '\\DOTSB\\operatorname*{proj\\,lim}'),
      dn('\\varlimsup', '\\DOTSB\\operatorname*{\\overline{lim}}'),
      dn('\\varliminf', '\\DOTSB\\operatorname*{\\underline{lim}}'),
      dn('\\varinjlim', '\\DOTSB\\operatorname*{\\underrightarrow{lim}}'),
      dn('\\varprojlim', '\\DOTSB\\operatorname*{\\underleftarrow{lim}}'),
      dn('\\gvertneqq', '\\html@mathml{\\@gvertneqq}{\u2269}'),
      dn('\\lvertneqq', '\\html@mathml{\\@lvertneqq}{\u2268}'),
      ...
      dn('\\varsubsetneq', '\\html@mathml{\\@varsubsetneq}{\u228a}'),
      dn('\\varsubsetneqq', '\\html@mathml{\\@varsubsetneqq}{\u2acb}'),
      dn('\\varsupsetneq', '\\html@mathml{\\@varsupsetneq}{\u228b}'),
      dn('\\varsupsetneqq', '\\html@mathml{\\@varsupsetneqq}{\u2acc}'),
      dn('\\imath', '\\html@mathml{\\@imath}{\u0131}'),
      dn('\\jmath', '\\html@mathml{\\@jmath}{\u0237}'),
      dn(
        '\\llbracket',
      ...
      dn('\\Complex', '\\mathbb{C}'),
      dn('\\Dagger', '\\ddagger'),
      dn('\\diamonds', '\\diamondsuit'),
      dn('\\empty', '\\emptyset'),
      dn('\\Epsilon', '\\mathrm{E}'),
      dn('\\Eta', '\\mathrm{H}'),
      dn('\\exist', '\\exists'),
      dn('\\harr', '\\leftrightarrow'),
      dn('\\hArr', '\\Leftrightarrow'),
      dn('\\Harr', '\\Leftrightarrow'),
      dn('\\hearts', '\\heartsuit'),
      dn('\\image', '\\Im'),
      ...
      dn('\\weierp', '\\wp'),
      dn('\\Zeta', '\\mathrm{Z}'),
      dn('\\argmin', '\\DOTSB\\operatorname*{arg\\,min}'),
      dn('\\argmax', '\\DOTSB\\operatorname*{arg\\,max}'),
      dn('\\plim', '\\DOTSB\\mathop{\\operatorname{plim}}\\limits'),
      dn('\\bra', '\\mathinner{\\langle{#1}|}'),
      dn('\\ket', '\\mathinner{|{#1}\\rangle}'),
      dn('\\braket', '\\mathinner{\\langle{#1}\\rangle}'),
      dn('\\Bra', '\\left\\langle#1\\right|'),
      dn('\\Ket', '\\left|#1\\right\\rangle'),
      dn('\\angln', '{\\angl n}'),
      dn('\\blue', '\\textcolor{##6495ed}{#1}'),
      dn('\\orange', '\\textcolor{##ffa500}{#1}'),
      dn('\\pink', '\\textcolor{##ff00af}{#1}'),
      dn('\\red', '\\textcolor{##df0030}{#1}'),
      dn('\\green', '\\textcolor{##28ae7b}{#1}'),
      dn('\\gray', '\\textcolor{gray}{#1}'),
      dn('\\purple', '\\textcolor{##9d38bd}{#1}'),
      dn('\\blueA', '\\textcolor{##ccfaff}{#1}'),
      dn('\\blueB', '\\textcolor{##80f6ff}{#1}'),
      dn('\\blueC', '\\textcolor{##63d9ea}{#1}'),
      dn('\\blueD', '\\textcolor{##11accd}{#1}'),
      dn('\\blueE', '\\textcolor{##0c7f99}{#1}'),
      dn('\\tealA', '\\textcolor{##94fff5}{#1}'),
      dn('\\tealB', '\\textcolor{##26edd5}{#1}'),
      dn('\\tealC', '\\textcolor{##01d1c1}{#1}'),
      dn('\\tealD', '\\textcolor{##01a995}{#1}'),
      dn('\\tealE', '\\textcolor{##208170}{#1}'),
      dn('\\greenA', '\\textcolor{##b6ffb0}{#1}'),
      dn('\\greenB', '\\textcolor{##8af281}{#1}'),
      dn('\\greenC', '\\textcolor{##74cf70}{#1}'),
      dn('\\greenD', '\\textcolor{##1fab54}{#1}'),
      dn('\\greenE', '\\textcolor{##0d923f}{#1}'),
      dn('\\goldA', '\\textcolor{##ffd0a9}{#1}'),
      dn('\\goldB', '\\textcolor{##ffbb71}{#1}'),
      dn('\\goldC', '\\textcolor{##ff9c39}{#1}'),
      dn('\\goldD', '\\textcolor{##e07d10}{#1}'),
      dn('\\goldE', '\\textcolor{##a75a05}{#1}'),
      dn('\\redA', '\\textcolor{##fca9a9}{#1}'),
      dn('\\redB', '\\textcolor{##ff8482}{#1}'),
      dn('\\redC', '\\textcolor{##f9685d}{#1}'),
      dn('\\redD', '\\textcolor{##e84d39}{#1}'),
      dn('\\redE', '\\textcolor{##bc2612}{#1}'),
      dn('\\maroonA', '\\textcolor{##ffbde0}{#1}'),
      dn('\\maroonB', '\\textcolor{##ff92c6}{#1}'),
      dn('\\maroonC', '\\textcolor{##ed5fa6}{#1}'),
      dn('\\maroonD', '\\textcolor{##ca337c}{#1}'),
      dn('\\maroonE', '\\textcolor{##9e034e}{#1}'),
      dn('\\purpleA', '\\textcolor{##ddd7ff}{#1}'),
      dn('\\purpleB', '\\textcolor{##c6b9fc}{#1}'),
      dn('\\purpleC', '\\textcolor{##aa87ff}{#1}'),
      dn('\\purpleD', '\\textcolor{##7854ab}{#1}'),
      dn('\\purpleE', '\\textcolor{##543b78}{#1}'),
      dn('\\mintA', '\\textcolor{##f5f9e8}{#1}'),
      dn('\\mintB', '\\textcolor{##edf2df}{#1}'),
      dn('\\mintC', '\\textcolor{##e0e5cc}{#1}'),
      dn('\\grayA', '\\textcolor{##f6f7f7}{#1}'),
      dn('\\grayB', '\\textcolor{##f0f1f2}{#1}'),
      dn('\\grayC', '\\textcolor{##e3e5e6}{#1}'),
      dn('\\grayD', '\\textcolor{##d6d8da}{#1}'),
      dn('\\grayE', '\\textcolor{##babec2}{#1}'),
      dn('\\grayF', '\\textcolor{##888d93}{#1}'),
      dn('\\grayG', '\\textcolor{##626569}{#1}'),
      dn('\\grayH', '\\textcolor{##3b3e40}{#1}'),
      dn('\\grayI', '\\textcolor{##21242c}{#1}'),
      dn('\\kaBlue', '\\textcolor{##314453}{#1}'),
      dn('\\kaGreen', '\\textcolor{##71B307}{#1}');
    var Vn = {
        '\\relax': !0,
        '^': !0,
        _: !0,
      ...
      Gn = (function () {
        function e(e, t, r) {
          (this.settings = void 0),
            ...
            this.feed(e),
            (this.macros = new On(En, t.macros)),
            (this.mode = r),
            (this.stack = []);
        }
        var t = e.prototype;
        return (
          ...
          (t.scanArgument = function (e) {
            ...
            return (
              this.pushToken(new Cn('EOF', r.loc)),
              this.pushTokens(n),
              t.range(r, '')
            );
          }),
            ...
            if ('string' == typeof n) {
              ...
              if (-1 !== n.indexOf('#'))
                for (
                  ...
                  ++a;
              for (
                var o = new Rn(n, this.settings), s = [], l = o.lex();
                'EOF' !== l.text;
