!(function (e, t) {
  ...
  (e.prototype.onInit = function (e) {
    ...
    e.reply && this.channel.postMessage({ type: 'MP_INIT', reply: !1 });
  }),
              ...
              return (
                ...
                new Promise(function (n, s) {
                  t.postMessage({
                    ...
                    c
                      ? t.calls.set(t.rpc_counter, { resolve: n, reject: s })
                      : n();
                })
              );
            };
      ...
      n &&
        n[e.method]
          ...
          .then(function (n) {
            return (
              e.reply &&
              t.channel.postMessage({ type: 'MP_RETURN', id: e.id, result: n })
            );
          })
          .catch(function (n) {
    ...
    (e.prototype.onReturn = function (e) {
      if (this.calls.has(e.id)) {
        var t = this.calls.get(e.id),
          n = t.resolve,
          o = t.reject;
        this.calls.delete(e.id), e.error ? o(e.error) : n(e.result);
      }
    }),
    ...
    (e.prototype.get = function (e) {
      return new Promise(
        function (t, n) {
          var o = this;
          return this.foreign.has(e)
            ? t(this.foreign.get(e))
            : t(
  ...
  return function (t) {
    ...
    Object.defineProperties(this, {
      get: { writable: !1, configurable: !1, value: n.get.bind(n) },
      set: { writable: !1, configurable: !1, value: n.set.bind(n) },
    });
  };
});
