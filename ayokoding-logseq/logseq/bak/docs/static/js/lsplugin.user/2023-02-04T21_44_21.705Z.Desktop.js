  ...
  (() => {
    var t = {
        ...
        856: function (t) {
          t.exports = (function () {
            ...
            var w = I(Array.prototype.forEach),
              x = I(Array.prototype.pop),
              C = I(Array.prototype.push),
              O = I(String.prototype.toLowerCase),
              S = I(String.prototype.match),
              j = I(String.prototype.replace),
              A = I(String.prototype.indexOf),
              k = I(String.prototype.trim),
              E = I(RegExp.prototype.test),
              T = F(TypeError);
            function I(t) {
              return function (e) {
                for (
            ...
            function rt() {
              ...
              var r = e.document,
                ...
                u = e.NodeFilter,
                f = e.NamedNodeMap,
                p = void 0 === f ? e.NamedNodeMap || e.MozNamedAttrMap : f,
                d = e.HTMLFormElement,
                h = e.DOMParser,
                g = e.trustedTypes,
                v = l.prototype,
              ...
              if ('function' == typeof a) {
                var F = i.createElement('template');
                F.content &&
                  F.content.ownerDocument &&
                  (i = F.content.ownerDocument);
              }
              var ot = nt(g, r),
                it = ot ? ot.createHTML('') : '',
                st = i,
                ...
                pt = {};
              try {
                pt = N(i).documentMode ? i.documentMode : {};
              } catch (t) {}
              var dt = {};
              n.isSupported =
                'function' == typeof I &&
              ...
              var ht,
                ...
                xt = Y,
                Ct = null,
                Ot = L({}, [].concat(o(P), o(R), o(D), o($), o(H))),
                St = null,
                jt = L({}, [].concat(o(B), o(q), o(W), o(G))),
                At = Object.seal(
                  Object.create(null, {
                    tagNameCheck: {
                      writable: !0,
                ...
                se = function (e) {
                  (re && re === e) ||
                    ((e && 'object' === t(e)) || (e = {}),
                    (e = N(e)),
                    (Ct = 'ALLOWED_TAGS' in e ? L({}, e.ALLOWED_TAGS) : Ot),
                    (St = 'ALLOWED_ATTR' in e ? L({}, e.ALLOWED_ATTR) : jt),
                    (Zt =
                      'ADD_URI_SAFE_ATTR' in e
                        ? L(N(Vt), e.ADD_URI_SAFE_ATTR)
                        : Vt),
                    (Gt =
                      'ADD_DATA_URI_TAGS' in e
                        ? L(N(Jt), e.ADD_DATA_URI_TAGS)
                        : Jt),
                    (qt =
                      'FORBID_CONTENTS' in e ? L({}, e.FORBID_CONTENTS) : Wt),
                    (kt = 'FORBID_TAGS' in e ? L({}, e.FORBID_TAGS) : {}),
                    (Et = 'FORBID_ATTR' in e ? L({}, e.FORBID_ATTR) : {}),
                    (Bt = 'USE_PROFILES' in e && e.USE_PROFILES),
                    (Tt = !1 !== e.ALLOW_ARIA_ATTR),
                    (It = !1 !== e.ALLOW_DATA_ATTR),
                    (Ft = e.ALLOW_UNKNOWN_PROTOCOLS || !1),
                    (Lt = e.SAFE_FOR_TEMPLATES || !1),
                    (Nt = e.WHOLE_DOCUMENT || !1),
                    (Rt = e.RETURN_DOM || !1),
                    (Dt = e.RETURN_DOM_FRAGMENT || !1),
                    ...
                    e.CUSTOM_ELEMENT_HANDLING &&
                      ie(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck) &&
                      (At.tagNameCheck =
                        e.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
                    e.CUSTOM_ELEMENT_HANDLING &&
                      ie(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) &&
                    ...
                    Bt &&
                      ((Ct = L({}, o(H))),
                      (St = []),
                      !0 === Bt.html && (L(Ct, P), L(St, B)),
                      !0 === Bt.svg && (L(Ct, R), L(St, q), L(St, G)),
                      !0 === Bt.svgFilters && (L(Ct, D), L(St, q), L(St, G)),
                      !0 === Bt.mathMl && (L(Ct, $), L(St, W), L(St, G))),
                    e.ADD_TAGS &&
                      (Ct === Ot && (Ct = N(Ct)), L(Ct, e.ADD_TAGS)),
                    e.ADD_ATTR &&
                      (St === jt && (St = N(St)), L(St, e.ADD_ATTR)),
                    e.ADD_URI_SAFE_ATTR && L(Zt, e.ADD_URI_SAFE_ATTR),
                    e.FORBID_CONTENTS &&
                      (qt === Wt && (qt = N(qt)), L(qt, e.FORBID_CONTENTS)),
                    zt && (Ct['#text'] = !0),
                    Nt && L(Ct, ['html', 'head', 'body']),
                    Ct.table && (L(Ct, ['tbody']), delete kt.tbody),
                    m && m(e),
                    (re = e));
                },
                ae = L({}, ['mi', 'mo', 'mn', 'ms', 'mtext']),
                ce = L({}, [
                  'foreignobject',
                  'desc',
                  'title',
                ...
                le = L({}, ['title', 'style', 'font', 'a', 'script']),
                ue = L({}, R);
              L(ue, D), L(ue, U);
              var fe = L({}, $);
              L(fe, z);
              var pe = function (t) {
                  var e = I(t);
                  (e && e.tagName) ||
                    (e = { namespaceURI: Qt, tagName: 'template' });
                  var n = O(t.tagName),
                    r = O(e.tagName);
                  return t.namespaceURI === Yt
                    ? e.namespaceURI === Qt
                      ? 'svg' === n
                      : e.namespaceURI === Kt
                      ? 'svg' === n && ('annotation-xml' === r || ae[r])
                      : Boolean(ue[n])
                    : t.namespaceURI === Kt
                    ? e.namespaceURI === Qt
                      ? 'math' === n
                      ...
                      : Boolean(fe[n])
                    : t.namespaceURI === Qt &&
                      !(e.namespaceURI === Yt && !ce[r]) &&
                      !(e.namespaceURI === Kt && !ae[r]) &&
                      !fe[n] &&
                      (le[n] || !ue[n]);
                },
                de = function (t) {
                  C(n.removed, { element: t });
                  try {
                ...
                he = function (t, e) {
                  try {
                    C(n.removed, { attribute: e.getAttributeNode(t), from: e });
                  } catch (t) {
                    C(n.removed, { attribute: null, from: e });
                  }
                ...
                _e = function (t) {
                  var e;
                  if ((be('beforeSanitizeElements', t, null), ve(t)))
                    return de(t), !0;
                  if (E(/[\u0080-\uFFFF]/, t.nodeName)) return de(t), !0;
                  var r = mt(t.nodeName);
                  if (
                    (be('uponSanitizeElement', t, {
                      tagName: r,
                      allowedTags: Ct,
                    }),
                    t.hasChildNodes() &&
                      !ye(t.firstElementChild) &&
                      (!ye(t.content) || !ye(t.content.firstElementChild)) &&
                      E(/<[/\w]/g, t.innerHTML) &&
                      E(/<[/\w]/g, t.textContent))
                  )
                    return de(t), !0;
                  ...
                  if (!Ct[r] || kt[r]) {
                    if (!kt[r] && xe(r)) {
                      if (
                        At.tagNameCheck instanceof RegExp &&
                        E(At.tagNameCheck, r)
                      )
                        return !1;
                      if (
                    ...
                    if (zt && !qt[r]) {
                      var o = I(t) || t.parentNode,
                        i = _(t) || t.childNodes;
                      if (i && o)
                        for (var s = i.length - 1; s >= 0; --s)
                          o.insertBefore(y(i[s], !0), b(t));
                    }
                    return de(t), !0;
                  }
                  return t instanceof l && !pe(t)
                    ? (de(t), !0)
                    ...
                    ? (Lt &&
                        ...
                        (e = j(e, vt, ' ')),
                        t.textContent !== e &&
                          (C(n.removed, { element: t.cloneNode() }),
                          (t.textContent = e))),
                ...
                we = function (t, e, n) {
                  if ($t && ('id' === e || 'name' === e) && (n in i || n in oe))
                    return !1;
                  if (It && !Et[e] && E(yt, e));
                  else if (Tt && E(bt, e));
                  else if (!St[e] || Et[e]) {
                  ...
                  if (s) {
                    ...
                    for (i = s.length; i--; ) {
                      var c = (e = s[i]),
                        ...
                        u = c.namespaceURI;
                      if (
                        ((r = 'value' === l ? e.value : k(e.value)),
                        (o = mt(l)),
                        (a.attrName = o),
                        (a.attrValue = r),
                        (a.keepAttr = !0),
                        (a.forceKeepAttr = void 0),
                        be('uponSanitizeAttribute', t, a),
                        (r = a.attrValue),
                        !a.forceKeepAttr && (he(l, t), a.keepAttr))
                      )
                        if (E(/\/>/i, r)) he(l, t);
                        else {
                          Lt && ((r = j(r, gt, ' ')), (r = j(r, vt, ' ')));
                          var f = mt(t.nodeName);
                          if (we(f, o, r))
                            try {
                              u
                                ? t.setAttributeNS(u, l, r)
                                : t.setAttribute(l, r),
                                x(n.removed);
                            } catch (t) {}
                        }
                ...
                Oe = function t(e) {
                  var n,
                    r = ge(e);
                  for (
                    be('beforeSanitizeShadowDOM', e, null);
                    (n = r.nextNode());

                  )
                    be('uponSanitizeShadowNode', n, null),
                      _e(n) || (n.content instanceof s && t(n.content), Ce(n));
              ...
              return (
                (n.sanitize = function (o, i) {
                  ...
                  if (!n.isSupported) {
                    if (
                      'object' === t(e.toStaticHTML) ||
                      'function' == typeof e.toStaticHTML
                    ) {
                      if ('string' == typeof o) return e.toStaticHTML(o);
                      if (ye(o)) return e.toStaticHTML(o.outerHTML);
                    }
                    return o;
                  }
                  if (
                    ...
                    (1 ===
                      (l = (a = me('\x3c!----\x3e')).ownerDocument.importNode(
                        o,
                        !0
                      )).nodeType &&
                      'BODY' === l.nodeName) ||
                    ...
                    if (!Rt && !Lt && !Nt && -1 === o.indexOf('<'))
                      return ot && Ut ? ot.createHTML(o) : o;
                    if (!(a = me(o))) return Rt ? null : Ut ? it : '';
                  }
                  a && Pt && de(a.firstChild);
                  for (var h = ge(Ht ? o : a); (u = h.nextNode()); )
                    (3 === u.nodeType && u === f) ||
                      _e(u) ||
                      (u.content instanceof s && Oe(u.content), Ce(u), (f = u));
                  if (((f = null), Ht)) return o;
                  if (Rt) {
                    if (Dt)
                      for (p = lt.call(a.ownerDocument); a.firstChild; )
                        p.appendChild(a.firstChild);
                    else p = a;
                    return St.shadowroot && (p = ft.call(r, p, !0)), p;
                  }
                  var m = Nt ? a.outerHTML : a.innerHTML;
                  return (
                    Nt &&
                      Ct['!doctype'] &&
                      a.ownerDocument &&
                      ...
                      E(tt, a.ownerDocument.doctype.name) &&
                      (m =
                        '<!DOCTYPE ' +
                        a.ownerDocument.doctype.name +
                        '>\n' +
                        m),
                    Lt && ((m = j(m, gt, ' ')), (m = j(m, vt, ' '))),
                    ot && Ut ? ot.createHTML(m) : m
                  );
                }),
        ...
        729: (t) => {
          ...
          Object.create &&
            ...
            (a.prototype.emit = function (t, e, r, o, i, s) {
              ...
              if (u.fn) {
                switch (
                  (u.once && this.removeListener(t, u.fn, void 0, !0), f)
                ) {
                  case 1:
                  ...
                  case 4:
                    return u.fn.call(u.context, e, r, o), !0;
                  case 5:
                    return u.fn.call(u.context, e, r, o, i), !0;
                  case 6:
                    return u.fn.call(u.context, e, r, o, i, s), !0;
                }
        ...
        520: (t, e, n) => {
          ...
          function p(t) {
            var e = c.exec(t),
              n = e[1] || '',
              r = !!n && ':' !== n[1];
            return { device: n, isUnc: r, isAbsolute: r || !!e[2], tail: e[3] };
          }
          function d(t) {
          ...
          (m.resolve = function () {
            ...
            (m.normalize = function (t) {
              var e = m.isAbsolute(t),
                n = t && '/' === t[t.length - 1];
              return (
                (t = s(t.split('/'), !e).join('/')) || e || (t = '.'),
                t && n && (t += '/'),
                (e ? '/' : '') + t
              );
            }),
            ...
            (m.relative = function (t, e) {
              (t = m.resolve(t).substr(1)), (e = m.resolve(e).substr(1));
              for (
                var n = a(t.split('/')),
                  r = a(e.split('/')),
            ...
            (m.format = function (t) {
              ...
              return (t.dir ? t.dir + m.sep : '') + (t.base || '');
            }),
            (m.parse = function (t) {
              if (!i.isString(t))
                throw new TypeError(
    ...
    return (
      (() => {
        'use strict';
        n.r(r),
          n.d(r, { LSPluginUser: () => Co, setupPluginUserInstance: () => Oo });
        var t = n(520);
        n(856);
        const e = function () {
        ...
        const b = v || y || Function('return this')();
        const _ = b.Symbol;
        ...
        const S = function (t) {
          ...
          var o = C.call(t);
          return r && (e ? (t[O] = n) : delete t[O]), o;
        };
        var j = Object.prototype.toString;
        const A = function (t) {
          return j.call(t);
        };
        var k = _ ? _.toStringTag : void 0;
        const E = function (t) {
          return null == t
            ? void 0 === t
              ? '[object Undefined]'
        ...
        const F = b['__core-js_shared__'];
        var L,
          N = (L = /[^.]+$/.exec((F && F.keys && F.keys.IE_PROTO) || ''))
            ? 'Symbol(src)_1.' + L
            : '';
        const M = function (t) {
          return !!N && N in t;
        ...
        const q = function (t) {
          return !(!T(t) || M(t)) && (I(t) ? B : D).test(R(t));
        };
        ...
        const tt = function (t) {
          var e = this.__data__;
          return Z ? void 0 !== e[t] : X.call(e, t);
        };
        ...
        (nt.prototype.clear = V),
          (nt.prototype.delete = K),
          (nt.prototype.get = Q),
          (nt.prototype.has = tt),
          (nt.prototype.set = et);
        const rt = nt;
        ...
        var _t =
          ...
          wt =
            ...
            !module.nodeType &&
            module,
          xt = wt && wt.exports === _t ? b.Buffer : void 0,
          Ct = xt ? xt.allocUnsafe : void 0;
        ...
        const Ft = It(Object.getPrototypeOf, Object);
        ...
        const Mt = function (t) {
          return 'function' != typeof t.constructor || Nt(t) ? {} : Tt(Ft(t));
        };
        const Pt = function (t) {
          return null != t && 'object' == typeof t;
        };
        const Rt = function (t) {
          return Pt(t) && '[object Arguments]' == E(t);
        };
        var Dt = Object.prototype,
          Ut = Dt.hasOwnProperty,
          $t = Dt.propertyIsEnumerable;
        const zt = Rt(
          (function () {
            return arguments;
          })()
          ...
          ? Rt
          : function (t) {
              return Pt(t) && Ut.call(t, 'callee') && !$t.call(t, 'callee');
            };
        ...
        var Jt =
          ...
          Zt =
            ...
            !module.nodeType &&
            module,
          Vt = Zt && Zt.exports === Jt ? b.Buffer : void 0;
        const Kt = (Vt ? Vt.isBuffer : void 0) || Gt;
        var Yt = Function.prototype,
          Qt = Object.prototype,
          Xt = Yt.toString,
          te = Qt.hasOwnProperty,
          ee = Xt.call(Object);
        const ne = function (t) {
          if (!Pt(t) || '[object Object]' != E(t)) return !1;
          var e = Ft(t);
          if (null === e) return !0;
          var n = te.call(e, 'constructor') && e.constructor;
        ...
        (re['[object Float32Array]'] =
          ...
          (re['[object Arguments]'] =
            ...
            re['[object WeakMap]'] =
              !1);
        const oe = function (t) {
          return Pt(t) && Bt(t.length) && !!re[E(t)];
        };
        const ie = function (t) {
          return function (e) {
            return t(e);
        ...
        var ue = le && le.isTypedArray;
        const fe = ue ? ie(ue) : oe;
        ...
        const he = function (t, e, n) {
          var r = t[e];
          (de.call(t, e) && o(r, n) && (void 0 !== n || e in t)) || vt(t, e, n);
        };
        const me = function (t, e, n, r) {
          var o = !n;
          n || (n = {});
          for (var i = -1, s = e.length; ++i < s; ) {
            var a = e[i],
              c = r ? r(n[a], t[a], a, n, t) : void 0;
            void 0 === c && (c = t[a]), o ? vt(n, a, c) : he(n, a, c);
          }
          return n;
        };
        ...
        const Ce = function (t) {
          ...
          var e = Nt(t),
            n = [];
          for (var r in t)
            ('constructor' != r || (!e && xe.call(t, r))) && n.push(r);
          return n;
        };
        const Oe = function (t) {
          return qt(t) ? _e(t, !0) : Ce(t);
        };
        const Se = function (t) {
          return me(t, Oe(t));
        };
        const je = function (t, e, n, r, o, i, s) {
          var a = pe(t, n),
            c = pe(e, n),
            l = s.get(c);
          if (l) yt(t, n, l);
          else {
            var u = i ? i(a, c, n + '', t, e, s) : void 0,
              f = void 0 === u;
            if (f) {
              var p = Ht(c),
                d = !p && Kt(c),
              ...
              (u = c),
                p || d || h
                  ...
                  : ne(c) || zt(c)
                  ? ((u = a),
                    zt(a) ? (u = Se(a)) : (T(a) && !I(a)) || (u = Mt(c)))
                  : (f = !1);
            }
            f && (s.set(c, u), o(u, c, r, i, s), s.delete(c)), yt(t, n, u);
          }
        };
        const Ae = function t(e, n, r, o, i) {
          e !== n &&
            bt(
              n,
              function (s, a) {
                if ((i || (i = new mt()), T(s))) je(e, n, a, r, t, o, i);
                else {
                  var c = o ? o(pe(e, a), s, a + '', e, n, i) : void 0;
                  void 0 === c && (c = s), yt(e, a, c);
                }
              },
              Oe
            );
          ...
          return Pe(function (e, n) {
            ...
            for (
              i = t.length > 3 && 'function' == typeof i ? (o--, i) : void 0,
                s && Re(n[0], n[1], s) && ((i = o < 3 ? void 0 : i), (o = 1)),
                e = Object(e);
              ++r < o;
        ...
        var ze = [/([a-z0-9])([A-Z])/g, /([A-Z])([A-Z][a-z])/g],
          He = /[^A-Z0-9]+/gi;
        function Be(t, e, n) {
        ...
        function qe(t, e) {
          return (
            ...
            (function (t, e) {
              ...
              return u.slice(f, p).split('\0').map(a).join(l);
            })(t, Ue({ delimiter: '.' }, e))
          );
        }
        var We = n(729),
        ...
        const Ze =
          'win32' === navigator.platform.toLowerCase() ? t.win32 : t.posix;
        const Ve = function (t, e) {
          return void 0 === e && (e = {}), qe(t, Ue({ delimiter: '_' }, e));
        };
        const Ke = De;
        class Ye extends Ge() {
          constructor(t, e) {
          ...
          write(t, e, n) {
            ...
            var i;
            (this._logs.push([t, o]),
            n || (null !== (r = this._opts) && void 0 !== r && r.console)) &&
              (null === (i = console) ||
                void 0 === i ||
                i['ERROR' === t ? 'error' : 'debug'](`${t}: ${o}`));
            this.emit('change');
          }
          clear() {
        ...
        function Qe(t, ...e) {
          try {
            ...
            const r = Ze.join(t.substr(n.origin.length), ...e);
            return n.origin + r;
          } catch (n) {
            return Ze.join(t, ...e);
          }
        ...
        const on = 'application/x-postmate-v1+json';
        let sn = 0;
        const an = {
            handshake: 1,
            'handshake-reply': 1,
        ...
        class ln {
          constructor(t) {
            rn(this, 'parent', void 0),
              rn(this, 'frame', void 0),
              rn(this, 'child', void 0),
              rn(this, 'events', {}),
              rn(this, 'childOrigin', void 0),
              rn(this, 'listener', void 0),
              (this.parent = t.parent),
              (this.frame = t.frame),
              (this.child = t.child),
              (this.childOrigin = t.childOrigin),
              (this.listener = (t) => {
                if (!cn(t, this.childOrigin)) return !1;
                const { data: e, name: n } = ((t || {}).data || {}).value || {};
          ...
          call(t, e) {
            this.child.postMessage(
              { postmate: 'call', type: on, property: t, data: e },
              this.childOrigin
            );
          }
          on(t, e) {
        ...
        class un {
          constructor(t) {
            rn(this, 'model', void 0),
              rn(this, 'parent', void 0),
              rn(this, 'parentOrigin', void 0),
              rn(this, 'child', void 0),
              (this.model = t.model),
              (this.parent = t.parent),
              ...
              this.child.addEventListener('message', (t) => {
                if (!cn(t, this.parentOrigin)) return;
                const { property: e, uid: n, data: r, args: o } = t.data;
                'call' !== t.data.postmate
                  ? ((t, e, n) => {
                      const r =
                        'function' == typeof t[e] ? t[e].apply(null, n) : t[e];
                      return Promise.resolve(r);
                    })(this.model, e, o).then((r) => {
          ...
          emit(t, e) {
            this.parent.postMessage(
              { postmate: 'emit', type: on, value: { name: t, data: e } },
              this.parentOrigin
            );
          }
        }
        class fn {
          ...
          sendHandshake(t) {
            const e = ((t) => {
              ...
              e.href = t;
              const n =
                  e.protocol.length > 4 ? e.protocol : window.location.protocol,
                r = e.host.length
            ...
            return new Promise((o, i) => {
              ...
              const a = () => {
                r++,
                  this.child.postMessage(
                    { postmate: 'handshake', type: on, model: this.model },
                    e
                  ),
                  5 === r && clearInterval(n);
              };
        ...
        rn(fn, 'debug', !1), rn(fn, 'Model', void 0);
        class pn {
          constructor(t) {
            rn(this, 'child', void 0),
              rn(this, 'model', void 0),
                  ...
                  if ('handshake' === r.data.postmate) {
                    0,
                      ...
                      r.source.postMessage(
                        { postmate: 'handshake-reply', type: on },
                        r.origin
                      ),
        ...
        const { importHTML: hn, createSandboxContainer: mn } =
          window.QSandbox || {};
        function gn(t, e) {
        ...
        class vn extends Ge() {
          constructor(t) {
            super(),
              dn(this, '_pluginLocal', void 0),
              dn(this, '_frame', void 0),
              dn(this, '_root', void 0),
              dn(this, '_loaded', !1),
              dn(this, '_unmountFns', []),
              (this._pluginLocal = t),
              t._dispose(() => {
          ...
          async load() {
            ...
            const { template: n, execScripts: r } = await hn(e, { fetch: gn });
            this._mount(n, document.body);
            const o = mn(t, {
              elementGetter: () => {
                var t;
                return null === (t = this._root) || void 0 === t
                  ? void 0
                  : t.firstChild;
              },
            }).instance.proxy;
            (o.__shadow_mode__ = !0),
              ...
              (o.LSPluginUser = o.logseq =
                new Co(this._pluginLocal.toJSON(), this._pluginLocal.caller));
            const i = await r(o, !0);
        ...
        class On extends Ge() {
          constructor(t) {
            super(),
              yn(this, '_pluginLocal', void 0),
              yn(this, '_connected', !1),
              yn(this, '_parent', void 0),
              yn(this, '_child', void 0),
              yn(this, '_shadow', void 0),
              yn(this, '_status', void 0),
              yn(this, '_userModel', {}),
              yn(this, '_call', void 0),
              yn(this, '_callUserModel', void 0),
              yn(this, '_debugTag', ''),
              (this._pluginLocal = t),
          ...
          async connectToParent(t = {}) {
            ...
            const i = new Map(),
              ...
              a = this._extendUserModel({
                '#lspmsg#ready#': async (t) => {
                  (a[Cn(null == t ? void 0 : t.pid)] = ({
                    type: t,
                    payload: n,
                  }) => {
                    bn(`[host (_call) -> *user] ${this._debugTag}`, t, n),
                      e.emit(t, n);
                  }),
                    await s.resolve();
                },
                ...
                [wn]: async ({ ns: t, type: n, payload: r }) => {
                  bn(
                    `[host (async) -> *user] ${this._debugTag} ns=${t} type=${n}`,
                    r
                  ),
                    t && t.startsWith('hook')
                      ? e.emit(`${t}:${n}`, r)
                ...
                '#lspmsg#reply#': ({ _sync: t, result: e }) => {
                  if ((bn(`[sync host -> *user] #${t}`, e), i.has(t))) {
                    const n = i.get(t);
                    n &&
                      (null != e && e.hasOwnProperty(xn)
                        ? n.reject(e[xn])
                        : n.resolve(e),
                      i.delete(t));
                  }
            ...
            if (n)
              return (
                ...
                JSON.parse(
                  JSON.stringify(
                    null === (c = this._pluginLocal) || void 0 === c
                      ? void 0
                      : c.toJSON()
                  )
                )
              );
            const l = new pn(a).sendHandshakeReply();
            return (
                ...
                .then((t) => {
                  (this._child = t),
                    ...
                    (this._call = async (e, n = {}, r) => {
                      ...
                      return (
                        t.emit(Cn(a.baseInfo.id), { type: e, payload: n }),
          ...
          async call(t, e = {}) {
            var n;
            return null === (n = this._call) || void 0 === n
              ? void 0
              : n.call(this, t, e);
          }
          async callAsync(t, e = {}) {
          ...
          async callUserModel(t, ...e) {
            var n;
            return null === (n = this._callUserModel) || void 0 === n
              ? void 0
              : n.apply(this, [t, ...e]);
          }
          async callUserModelAsync(t, ...e) {
            var n;
            return (
              (t = `${_n}${t}`),
              null === (n = this._callUserModel) || void 0 === n
                ? void 0
                : n.apply(this, [t, ...e])
            );
          }
          async _setupIframeSandbox() {
            const t = this._pluginLocal,
              e = t.id,
              n = `${e}_lsp_main`,
              r = new URL(t.options.entry);
            r.searchParams.set('__v__', t.options.version);
            ...
            try {
              var s;
              const t =
                null === (s = await this._pluginLocal._loadLayoutsData()) ||
                void 0 === s
                  ? void 0
                  : s.$$0;
              if (t) {
                i.dataset.inited_layout = 'true';
                let { width: e, height: n, left: r, top: o, vw: s, vh: a } = t;
                (r = Math.max(r, 0)),
                  (r =
                    'number' == typeof s
                      ? `${Math.min((100 * r) / s, 99)}%`
            ...
            return (
              ...
              new Promise((e, n) => {
                  ...
                  l
                    .then((n) => {
                      (this._parent = n),
                        (this._connected = !0),
                        this.emit('connected'),
                        n.on(Cn(t.id), ({ type: t, payload: e }) => {
                          var n, r;
                          bn('[user -> *host] ', t, e),
                            null === (n = this._pluginLocal) ||
                              void 0 === n ||
                              n.emit(t, e || {}),
                            null === (r = this._pluginLocal) ||
                              void 0 === r ||
                              r.caller.emit(t, e || {});
                        }),
                        (this._call = async (...e) => {
                          await n.call(Cn(t.id), {
                            type: e[0],
                            payload: Object.assign(e[1] || {}, { $$pid: t.id }),
                          });
                        }),
                        (this._callUserModel = async (t, ...e) => {
                          if (t.startsWith(_n))
                            return await n.get(t.replace(_n, ''), ...e);
                          n.call(t, null == e ? void 0 : e[0]);
                        }),
                        e(null);
                    })
                    .catch((t) => {
                ...
                .catch((t) => {
                  throw (bn('[iframe sandbox] error', t), t);
                })
                .finally(() => {
                  this._status = void 0;
                })
            ...
            try {
              (this._status = 'pending'),
                ...
                (this._call = async (e, n = {}, r) => {
                  ...
                  return (
                    r && (n.actor = r),
                    null === (o = this._pluginLocal) ||
                      void 0 === o ||
                      o.emit(e, Object.assign(n, { $$pid: t.id })),
                    null == r ? void 0 : r.promise
                  );
                }),
              ...
              throw (bn('[shadow sandbox] error', t), t);
            } finally {
              this._status = void 0;
            }
          }
          ...
          _getSandboxIframeContainer() {
            var t;
            return null === (t = this._parent) || void 0 === t
              ? void 0
              : t.frame.parentNode;
          }
          _getSandboxShadowContainer() {
            var t;
            return null === (t = this._shadow) || void 0 === t
              ? void 0
              : t.frame.parentNode;
          }
          ...
          async destroy() {
            ...
            this._parent &&
              ...
              null === (t = e) || void 0 === t || t.parentNode.removeChild(e);
          }
        }
        function Sn(t, e, n) {
          return (
        ...
        class An {
          ...
          invokeExperMethod(t, ...e) {
            var n, r;
            const o = this.ensureHostScope();
            return (
              (t =
                null === (n = Ve(t)) || void 0 === n
                  ? void 0
                  : n.toLowerCase()),
              null === (r = o.logseq.api['exper_' + t]) || void 0 === r
                ? void 0
                : r.apply(o, e)
            );
          }
          async loadScripts(...t) {
            (t = t.map((t) =>
              null != t && t.startsWith('http')
                ? t
                : this.ctx.resolveResourceFullUrl(t)
            )).unshift(this.ctx.baseInfo.id),
              await this.invokeExperMethod('loadScripts', ...t);
          }
          registerFencedCodeRenderer(t, e) {
          ...
          registerExtensionsEnhancer(t, e) {
            const n = this.ensureHostScope();
            if ('katex' === t) n.katex && e(n.katex).catch(console.error);
            return n.logseq.api.exper_register_extensions_enhancer(
              this.ctx.baseInfo.id,
              t,
              e
            );
        ...
        const En = (t) => `task_callback_${t}`;
        class Tn {
          constructor(t, e, n = {}) {
            kn(this, '_client', void 0),
              kn(this, '_requestId', void 0),
              kn(this, '_requestOptions', void 0),
              kn(this, '_promise', void 0),
              kn(this, '_aborted', !1),
              (this._client = t),
              (this._requestId = e),
              (this._requestOptions = n),
              (this._promise = new Promise((t, e) => {
                if (!this._requestId) return e(null);
                this._client.once(En(this._requestId), (n) => {
                  n && n instanceof Error ? e(n) : t(n);
                });
              }));
        ...
        class In extends We.EventEmitter {
          constructor(t) {
            super(),
              kn(this, '_ctx', void 0),
              (this._ctx = t),
              this.ctx.caller.on('#lsp#request#callback', (t) => {
                const e = null == t ? void 0 : t.requestId;
                e && this.emit(En(e), null == t ? void 0 : t.payload);
              });
          }
          static createRequestTask(t, e, n) {
            return new Tn(t, e, n);
          }
          async _request(t) {
            const e = this.ctx.baseInfo.id,
              { success: n, fail: r, final: o, ...i } = t,
              s = this.ctx.Experiments.invokeExperMethod('request', e, i),
              a = In.createRequestTask(this.ctx.Request, s, t);
        ...
        const Fn = It(Object.keys, Object);
        var Ln = Object.prototype.hasOwnProperty;
        const Nn = function (t) {
          if (!Nt(t)) return Fn(t);
          var e = [];
          for (var n in Object(t))
            Ln.call(t, n) && 'constructor' != n && e.push(n);
          return e;
        };
        const Mn = function (t) {
          return qt(t) ? _e(t) : Nn(t);
        };
        ...
        (Un.prototype.add = Un.prototype.push = Rn), (Un.prototype.has = Dn);
        const $n = Un;
        ...
        const Bn = function (t, e, n, r, o, i) {
          ...
          for (i.set(t, e), i.set(e, t); ++f < a; ) {
            var h = t[f],
              m = e[f];
            if (r) var g = s ? r(m, h, f, e, t, i) : r(h, m, f, t, e, i);
            if (void 0 !== g) {
              if (g) continue;
              p = !1;
              break;
        ...
        var Gn = _ ? _.prototype : void 0,
          Jn = Gn ? Gn.valueOf : void 0;
        const Zn = function (t, e, n, r, i, s, a) {
          switch (n) {
            ...
            case '[object ArrayBuffer]':
              return !(
                t.byteLength != e.byteLength || !s(new St(t), new St(e))
              );
            case '[object Boolean]':
            case '[object Date]':
            case '[object Number]':
            ...
            case '[object Set]':
              var l = 1 & r;
              if ((c || (c = Wn), t.size != e.size && !l)) return !1;
              var u = a.get(t);
              if (u) return u == e;
              (r |= 2), a.set(t, e);
              var f = Bn(c(t), c(e), r, i, s, a);
              return a.delete(t), f;
            case '[object Symbol]':
        ...
        const or = function (t, e, n, r, o, i) {
          var s = 1 & n,
            a = nr(t),
            c = a.length;
          if (c != nr(e).length && !s) return !1;
          for (var l = c; l--; ) {
            var u = a[l];
            if (!(s ? u in e : rr.call(e, u))) return !1;
          }
          var f = i.get(t),
            p = i.get(e);
          ...
          for (var h = s; ++l < c; ) {
            var m = t[(u = a[l])],
              g = e[u];
            if (r) var v = s ? r(g, m, u, e, t, i) : r(m, g, u, t, e, i);
        ...
        const ir = G(b, 'DataView');
        const sr = G(b, 'Promise');
        const ar = G(b, 'Set');
        const cr = G(b, 'WeakMap');
        var lr = '[object Map]',
          ur = '[object Promise]',
          fr = '[object Set]',
          pr = '[object WeakMap]',
          ...
          yr = R(cr),
          br = E;
        ((ir && br(new ir(new ArrayBuffer(1))) != dr) ||
          (J && br(new J()) != lr) ||
          (sr && br(sr.resolve()) != ur) ||
          (ar && br(new ar()) != fr) ||
          (cr && br(new cr()) != pr)) &&
        ...
        const Sr = function (t, e, n, r, o, i) {
          ...
          if (p && !u)
            return (
              i || (i = new mt()),
              s || fe(t) ? Bn(t, e, n, r, o, i) : Zn(t, e, c, n, r, o, i)
            );
          if (!(1 & n)) {
            var d = u && Or.call(t, '__wrapped__'),
              h = f && Or.call(e, '__wrapped__');
            if (d || h) {
              var m = d ? t.value() : t,
                g = h ? e.value() : e;
              return i || (i = new mt()), o(m, g, n, r, i);
            }
          }
          return !!p && (i || (i = new mt()), or(t, e, n, r, o, i));
        };
        const jr = function t(e, n, r, o, i) {
          return (
            e === n ||
            (null == e || null == n || (!Pt(e) && !Pt(n))
              ? e != e && n != n
              : Sr(e, n, r, o, t, i))
          );
        };
        const Ar = function (t, e, n, r) {
          var o = n.length,
            i = o,
            s = !r;
          if (null == t) return !i;
          ...
          for (; ++o < i; ) {
            ...
            if (s && a[2]) {
              ...
              var f = new mt();
              if (r) var p = r(l, u, c, t, e, f);
              if (!(void 0 === p ? jr(u, l, 3, r, f) : p)) return !1;
            }
          }
          return !0;
        };
        ...
        const Fr = function (t) {
          return 'symbol' == typeof t || (Pt(t) && '[object Symbol]' == E(t));
        };
        var Lr = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
          Nr = /^\w*$/;
        ...
        function Pr(t, e) {
          ...
          return (n.cache = new (Pr.Cache || pt)()), n;
        }
        Pr.Cache = pt;
        const Rr = Pr;
        var Dr =
        ...
        const $r = (function (t) {
          ...
          return (
            ...
            t.replace(Dr, function (t, n, r, o) {
              e.push(r ? o.replace(Ur, '$1') : n || t);
            }),
            e
          );
        });
        ...
        var Hr = _ ? _.prototype : void 0,
          Br = Hr ? Hr.toString : void 0;
        const qr = function t(e) {
          if ('string' == typeof e) return e;
          if (Ht(e)) return zr(e, t) + '';
          if (Fr(e)) return Br ? Br.call(e) : '';
          var n = e + '';
        ...
        const Gr = function (t, e) {
          return Ht(t) ? t : Mr(t, e) ? [t] : $r(Wr(t));
        };
        const Jr = function (t) {
          if ('string' == typeof t || Fr(t)) return t;
          var e = t + '';
          return '0' == e && 1 / t == -Infinity ? '-0' : e;
        };
        const Zr = function (t, e) {
          for (var n = 0, r = (e = Gr(e, t)).length; null != t && n < r; )
            t = t[Jr(e[n++])];
        ...
        const Yr = function (t, e, n) {
          for (var r = -1, o = (e = Gr(e, t)).length, i = !1; ++r < o; ) {
            var s = Jr(e[r]);
        ...
        const Xr = function (t, e) {
          return Mr(t) && kr(e)
            ...
            : function (n) {
                var r = Vr(n, t);
                return void 0 === r && r === e ? Qr(n, t) : jr(e, r, 3);
              };
        };
        const to = function (t) {
          return function (e) {
          ...
          constructor(t, e) {
            ...
            Object.entries({
              query: {
                ...
                reply: !0,
                transformOutput: (t) => (
                  Ht(null == t ? void 0 : t.blocks) &&
                    (t.blocks = t.blocks.map(
                      (t) => t && oo(t, (t, e) => `block/${e}`)
                    )),
                  t
                ),
              },
              ...
              const o = ((t) => `service:search:${t}:${e.name}`)(n);
              t.caller.on(o, async (n) => {
                if (I(null == e ? void 0 : e[r.f])) {
                  let i = null;
                  try {
                    (i = await e[r.f].apply(
                      e,
                    ...
                    console.error('[SearchService] ', t), (i = t);
                  } finally {
                    r.reply && t.caller.call(`${o}:reply`, i);
                  }
                }
              });
            });
        ...
        const co = Symbol.for('proxy-continue'),
          lo = nn()('LSPlugin:user'),
          uo = new Ye('', { console: !0 });
        function fo(t, e, n) {
          var r;
        ...
        function po(t) {
          return (
            ...
            ) || (uo.error(`#${t} is not a valid UUID string.`), !1)
          );
          var e;
        }
        let ho = null,
        ...
        const go = {
          async getInfo(t) {
            return (
              ho || (ho = await this._execCallableAPIAsync('get-app-info')),
              'string' == typeof t ? ho[t] : ho
            );
          },
          registerCommand: fo,
          ...
          registerCommandShortcut(t, e) {
            const { binding: n } = t,
              r = '$shortcut$',
              o = r + Ve(n);
            return fo.call(this, r, { key: o, palette: !1, keybinding: t }, e);
          },
          registerUIItem(t, e) {
            var n;
          ...
          registerPageMenuItem(t, e) {
            ...
            const n = t + '_' + this.baseInfo.id,
              r = t;
            fo.call(this, 'page-menu-item', { key: n, label: r }, e);
          },
          onBlockRendererSlotted(t, e) {
            if (!po(t)) return;
            const n = this.baseInfo.id,
              r = `hook:editor:${Ve(`slot:${t}`)}`;
            return (
              this.caller.on(r, e),
          ...
          invokeExternalPlugin(t, ...e) {
            var n;
            if (!(t = null === (n = t) || void 0 === n ? void 0 : n.trim()))
              return;
            let [r, o] = t.split('.');
            if (
              !['models', 'commands'].includes(
        ...
        const yo = {
            ...
            registerSlashCommand(t, e) {
              var n;
              lo('Register slash command #', this.baseInfo.id, t, e),
                'function' == typeof e &&
                  (e = [
            ...
            registerBlockContextMenuItem(t, e) {
              if ('function' != typeof e) return !1;
              const n = t + '_' + this.baseInfo.id;
              fo.call(this, 'block-context-menu-item', { key: n, label: t }, e);
            },
          ...
          bo = {
            ...
            datascriptQuery(t, ...e) {
              if (
                (e.pop(), null != e && e.some((t) => 'function' == typeof t))
              ) {
                return this.Experiments.ensureHostScope().logseq.api.datascript_query(
                  t,
                  ...e
                );
              }
              return this._execCallableAPIAsync('datascript_query', ...e);
            },
          },
          _o = {},
          wo = {},
          xo = {
            makeSandboxStorage() {
              return new jn(this, { assets: !0 });
            },
          };
        class Co extends Ge() {
          constructor(t, e) {
            super(),
              ao(this, '_baseInfo', void 0),
              ao(this, '_caller', void 0),
              ao(this, '_version', '0.0.13'),
              ao(this, '_debugTag', ''),
              ao(this, '_settingsSchema', void 0),
              ao(this, '_connected', !1),
              ao(this, '_ui', new Map()),
              ao(this, '_mFileStorage', void 0),
              ao(this, '_mRequest', void 0),
              ao(this, '_mExperiments', void 0),
              ao(this, '_beforeunloadCallback', void 0),
              (this._baseInfo = t),
              (this._caller = e),
              e.on('sys:ui:visible', (t) => {
                null != t && t.toggle && this.toggleMainUI();
              }),
              ...
              e.on('beforeunload', async (t) => {
                ...
                try {
                  o && (await o(r)), null == n || n.resolve(null);
                } catch (t) {
          ...
          async ready(t, e) {
            if (!this._connected)
              try {
                ...
                let r = await this._caller.connectToParent(t);
                (this._connected = !0),
                  (r = Ke(this._baseInfo, r)),
                  null !== (n = r) &&
                    void 0 !== n &&
                    n.id &&
                  ...
                  this._settingsSchema &&
                    ((r.settings = (function (t, e) {
                      const n = (e || []).reduce(
                        (t, e) => ('default' in e && (t[e.key] = e.default), t),
                        {}
                      );
                      return Object.assign(n, t);
                    })(r.settings, this._settingsSchema)),
                ...
                console.error(`${this._debugTag} [Ready Error]`, t);
              }
          }
          ensureConnected() {
          ...
          useSettingsSchema(t) {
            return (
              this.connected &&
                this.caller.call('settings:schema', { schema: t, isSync: !0 }),
          ...
          hideMainUI(t) {
            const e = {
              key: 0,
              visible: !1,
              cursor: null == t ? void 0 : t.restoreEditingCursor,
            };
          ...
          showMainUI(t) {
            const e = {
              key: 0,
              visible: !0,
              autoFocus: null == t ? void 0 : t.autoFocus,
            };
            this.caller.call('main-ui:visible', e),
              this.emit('ui:visible:changed', e),
              this._ui.set(e.key, e);
          ...
          get effect() {
            return (
              (t = this) &&
              ((null === (e = t.baseInfo) || void 0 === e
                ? void 0
                : e.effect) ||
                !(null !== (n = t.baseInfo) && void 0 !== n && n.iir))
            );
            var t, e, n;
          }
          get logger() {
          ...
          get settings() {
            var t;
            return null === (t = this.baseInfo) || void 0 === t
              ? void 0
              : t.settings;
          }
          get caller() {
          ...
          resolveResourceFullUrl(t) {
            if ((this.ensureConnected(), t))
              return (t = t.replace(/^[.\\/]+/, '')), Qe(this._baseInfo.lsr, t);
          }
          _makeUserProxy(t, e) {
            const n = this,
              r = this.caller;
                ...
                return function (...t) {
                  ...
                  if (e) {
                    ...
                    if (null != i) {
                      ...
                      return a ? void f() : (n.App._installPluginHook(c, l), f);
                    }
                  }
                  let i = o;
                  return (
                    ['git', 'ui', 'assets'].includes(e) && (i = e + '_' + i),
                    r.callAsync('api:call', { tag: e, method: i, args: t })
                  );
                };
              },
            });
          }
          _execCallableAPIAsync(t, ...e) {
            return this._caller.callAsync('api:call', { method: t, args: e });
          }
          _execCallableAPI(t, ...e) {
            this._caller.call('api:call', { method: t, args: e });
          }
          _callWin(...t) {
            return this._execCallableAPIAsync('_callMainWin', ...t);
          }
          get App() {
            return this._makeUserProxy(go, 'app');
          }
          get Editor() {
            return this._makeUserProxy(yo, 'editor');
          }
          get DB() {
            return this._makeUserProxy(bo, 'db');
          }
          get Git() {
            return this._makeUserProxy(_o, 'git');
          }
          get UI() {
            return this._makeUserProxy(wo, 'ui');
          }
          get Assets() {
            return this._makeUserProxy(xo, 'assets');
          }
          get FileStorage() {
            let t = this._mFileStorage;
            return t || (t = this._mFileStorage = new jn(this)), t;
          }
          get Request() {
            let t = this._mRequest;
            return t || (t = this._mRequest = new In(this)), t;
          }
          get Experiments() {
            let t = this._mExperiments;
            return t || (t = this._mExperiments = new An(this)), t;
          }
        }
        function Oo(t, e) {
          return new Co(t, e);
