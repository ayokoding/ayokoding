...
!(function (t) {
  ...
  var a = function (t) {
    ...
    l = {
      ...
      element: function (t) {
        ...
        return /object|function/.test(typeof n.Element)
  ...
  var f = {
      ...
      install: function (t) {
        var e = t.actions,
          n = t.Interactable,
          r = t.defaults;
        (n.prototype.draggable = f.draggable),
          (e.map.drag = f),
          (e.methodDict.drag = 'draggable'),
          (r.actions.drag = f.defaults);
      },
      listeners: {
  ...
  var h = {
    init: function (t) {
      var e = t;
      (h.document = e.document),
        (h.DocumentFragment = e.DocumentFragment || g),
        (h.SVGElement = e.SVGElement || g),
        (h.SVGSVGElement = e.SVGSVGElement || g),
        (h.SVGElementInstance = e.SVGElementInstance || g),
        (h.Element = e.Element || g),
        (h.HTMLElement = e.HTMLElement || h.Element),
        (h.Event = e.Event),
        (h.Touch = e.Touch || g),
        (h.PointerEvent = e.PointerEvent || e.MSPointerEvent);
    },
    document: null,
  ...
  function P(t, n) {
    return (
      ...
      t[y.default.prefixedMatchesSelector](n)
    );
  }
            ...
            if (s !== o.ownerDocument)
              if (l !== o.ownerDocument)
                if (s !== l) {
                  ...
                  for (
                    var u = S(c, a.ownerDocument), d = 0;
                    u[d] && u[d] === r[d];

                  )
                    d++;
                  for (
                    var f = [u[d - 1], u[d], r[d]], p = f[0].lastChild;
                    p;
                  ...
                  (h = o),
                    ...
                    void 0,
                    void 0,
                    (parseInt(e.getWindow(h).getComputedStyle(h).zIndex, 10) ||
                      0) >=
                      (parseInt(
  ...
  Object.defineProperty(I, '__esModule', { value: !0 }),
    (I.getStringOptionResult = D),
    (I.resolveRectLike = function (t, e, n, r) {
      var i = t;
      return (
        o.default.string(i)
          ? (i = D(i, e, n))
          : o.default.func(i) && (i = i.apply(void 0, r)),
        o.default.element(i) && (i = (0, _.getElementRect)(i)),
        i
      );
    }),
  ...
  Object.defineProperty(z, '__esModule', { value: !0 }),
    (z.default = function t(e, n, r) {
      if (
        ((r = r || {}),
        o.default.string(e) && -1 !== e.search(' ') && (e = A(e)),
        o.default.array(e))
      )
  ...
  function B(t, e) {
    return (
      (e = e || { x: 0, y: 0 }),
      y.default.isOperaMobile && Y(t)
        ? (W('screen', t, e), (e.x += window.scrollX), (e.y += window.scrollY))
        : W('page', t, e),
      e
    );
  }
  function L(t, e) {
    return (
      (e = e || {}),
      y.default.isOperaMobile && Y(t) ? W('screen', t, e) : W('client', t, e),
      e
    );
  }
  function N(t) {
  ...
  (q.BaseEvent = U),
    Object.defineProperty(U.prototype, 'interaction', {
      get: function () {
  ...
  Object.defineProperty(G, '__esModule', { value: !0 }),
    (G.find = G.findIndex = G.from = G.merge = G.remove = G.contains = void 0),
  ...
  var Z = (function (t) {
    ...
    function r(e, n, r) {
      var i;
      ((i = t.call(this, n._interaction) || this).target = void 0),
        (i.dropzone = void 0),
        (i.dragEvent = void 0),
        (i.relatedTarget = void 0),
        (i.draggable = void 0),
        (i.timeStamp = void 0),
        (i.propagationStopped = !1),
        (i.immediatePropagationStopped = !1);
      ...
      return (
        ...
        (i.dropzone = s),
        (i.dragEvent = n),
        (i.relatedTarget = n.target),
        (i.draggable = n.interactable),
            ...
            if (a.options.drop.enabled) {
              ...
              if (
                !(
                  ...
                  (o.default.string(s) && !_.matchesSelector(e, s)) ||
                  (o.default.func(s) &&
                    !s({ dropzone: a, draggableElement: e }))
                )
              )
                for (
                  var l = o.default.string(a.target)
                  ...
                  var u = l[c];
                  u !== e &&
                    r.push({ dropzone: a, element: u, rect: a.getRect(u) });
                }
            }
          }
          return r;
            ...
            return (function (t, e, n, r, i, a, s) {
              ...
              if (!(s = s || t.getRect(a)))
                return (
                  ...
                  t.options.drop.checker(e, n, l, t, a, r, i)
                );
              ...
              return (
                v &&
                  ...
                  (l =
                    ...
                    c),
                t.options.drop.checker &&
                  (l = t.options.drop.checker(e, n, l, t, a, r, i)),
                l
              );
            })(this, t, e, n, r, i, a);
          }),
        ...
        'interactions:after-action-start': function (t, e) {
          ...
          if ('drag' === n.prepared.name) {
            ...
            (i.activeDrops = null),
              ...
              (i.events = nt(n, 0, r)),
              i.events.activate &&
                (Q(i.activeDrops, i.events.activate),
  ...
  function lt(t) {
    ...
    if ('gesture' === e.prepared.name) {
      ...
      if (((n.touches = [i[0], i[1]]), a))
        (n.distance = X.touchDistance(i, l)),
          (n.box = X.touchBBox(i)),
          (n.scale = 1),
          (n.ds = 0),
          (n.angle = X.touchAngle(i, l)),
          (n.da = 0),
  ...
  function ft(t, e, n, r, i, a, s) {
    ...
    return (
      !!o.default.element(r) &&
      (o.default.element(e) ? e === r : _.matchesUpTo(r, e, i))
    );
  }
  function pt(t) {
    var e = t.iEvent,
          ...
          !(function (t) {
            ...
            if ('resize' === n.prepared.name && n.prepared.edges) {
              ...
              if (((0, T.default)(d, c), o)) {
                ...
                (c.top = Math.min(a.top, l.bottom)),
                  (c.bottom = Math.max(a.bottom, l.top)),
                  (c.left = Math.min(a.left, l.right)),
                  (c.right = Math.max(a.right, l.left));
              for (var v in ((c.width = c.right - c.left),
  ...
  var mt = {
    ...
    install: function (t) {
      t.usePlugin(st.default),
        t.usePlugin(dt.default),
        t.usePlugin(c.default),
        t.usePlugin(J.default);
    },
  };
  gt.default = mt;
  var yt = {};
  ...
  var xt,
    ...
    Pt = {
      ...
      init: function (t) {
        if (
          ((xt = t.requestAnimationFrame), (_t = t.cancelAnimationFrame), !xt)
        )
          for (var e = ['ms', 'moz', 'webkit', 'o'], n = 0; n < e.length; n++) {
            var r = e[n];
            (xt = t[r + 'RequestAnimationFrame']),
              (_t =
  ...
  var St = {
    ...
    start: function (t) {
      (St.isScrolling = !0),
        bt.default.cancel(St.i),
        (t.autoScroll = St),
        (St.interaction = t),
        (St.prevTime = St.now()),
        (St.i = bt.default.request(St.scroll));
    },
    stop: function () {
      (St.isScrolling = !1),
        St.interaction && (St.interaction.autoScroll = null),
        bt.default.cancel(St.i);
    },
    scroll: function () {
      var t = St.interaction,
        ...
        c = i.speed * l;
      if (c >= 1) {
        var u = { x: St.x * c, y: St.y * c };
        if (u.x || u.y) {
          var d = Ot(a);
          o.default.window(a)
            ? a.scrollBy(u.x, u.y)
            : a && ((a.scrollLeft += u.x), (a.scrollTop += u.y));
          var f = Ot(a),
            p = { x: f.x - d.x, y: f.y - d.y };
          (p.x || p.y) &&
            e.fire({
              type: 'autoscroll',
              target: n,
      ...
      St.isScrolling &&
        (bt.default.cancel(St.i), (St.i = bt.default.request(St.scroll)));
    },
    check: function (t, e) {
      var n;
    ...
    onInteractionMove: function (t) {
      var e = t.interaction,
        n = t.pointer;
      if (e.interacting() && St.check(e.interactable, e.prepared.name))
        if (e.simulation) St.x = St.y = 0;
        else {
          var r,
            i,
            a,
          ...
          if (o.default.window(f))
            (s = n.clientX < St.margin),
              (r = n.clientY < St.margin),
              (i = n.clientX > f.innerWidth - St.margin),
              (a = n.clientY > f.innerHeight - St.margin);
          else {
            var p = _.getElementClientRect(f);
            (s = n.clientX < p.left + St.margin),
              (r = n.clientY < p.top + St.margin),
              (i = n.clientX > p.right - St.margin),
              (a = n.clientY > p.bottom - St.margin);
          }
          (St.x = i ? 1 : s ? -1 : 0),
            (St.y = a ? 1 : r ? -1 : 0),
            St.isScrolling ||
              ((St.margin = d.margin), (St.speed = d.speed), St.start(e));
        }
    },
  };
  function Mt(t, n, r) {
    return (
      (o.default.string(t) ? (0, I.getStringOptionResult)(t, n, r) : t) ||
      (0, e.getWindow)(r)
    );
  }
  function Ot(t) {
  ...
  var Tt = {
    ...
    install: function (t) {
      ...
      (t.autoScroll = St),
        ...
        (e.perAction.autoScroll = St.defaults);
    },
    listeners: {
      'interactions:new': function (t) {
      ...
      'interactions:destroy': function (t) {
        (t.interaction.autoScroll = null),
          St.stop(),
          St.interaction && (St.interaction = null);
      },
  ...
  var At = {
    ...
    install: function (t) {
      ...
      (e.prototype.getAction = function (e, n, r, i) {
        ...
        (e.prototype.allowFrom = (0, It.warnOnce)(function (t) {
          return this._backCompatOption('allowFrom', t);
        }, 'Interactable.allowFrom() has been deprecated. Use Interactble.draggable({allowFrom: newValue}).')),
        (e.prototype.actionChecker = zt),
        (e.prototype.styleCursor = jt);
    },
  };
  Dt.default = At;
  var Ct = {};
        ...
        !(function (t, e) {
          ...
          (function (t, e) {
            ...
            if (
              ...
              i &&
                r &&
                (r.options[i].manualStart || !Yt(r, n.element, n.prepared, e)
                  ? n.stop()
                  : (n.start(n.prepared, r, n.element), Lt(n, e)));
            }
          })(t, e);
      },
      ...
      'autoStart:before-start': function (t, e) {
        ...
        if ('drag' === n.prepared.name) {
          var s = Math.abs(i),
            ...
            d = s > l ? 'x' : s < l ? 'y' : 'xy';
          if (
            ((n.prepared.axis = 'start' === c.lockAxis ? d[0] : c.lockAxis),
            'xy' !== d && 'xy' !== u && u !== d)
          ) {
                  ...
                  if (t !== n.interactable) {
                    ...
                    if (!i.manualStart && t.testIgnoreAllow(i, f, r)) {
                      ...
                      if (
                        ...
                        Ct.default.validateAction(o, t, f, r, e)
                      )
                        return t;
                    }
                  }
    ...
    install: function (t, e) {
      ...
      (t.logger = n || console),
        ...
        (r.prototype.devTools = function (t) {
          return t
            ? ((0, T.default)(this.options.devTools, t), this)
      ...
      'interactions:action-start': function (t, e) {
        for (var n = t.interaction, r = 0; r < se.length; r++) {
          ...
          (a && a.devTools && a.devTools.ignore[o.name]) ||
            !o.perform(n) ||
            (i = e.logger).warn.apply(i, [oe + o.text].concat(o.getInfo(n)));
        }
      },
    },
    checks: se,
    ...
    return (
      (e.start = function (t, e) {
        ...
        this.prepareStates(i),
          (this.edges = (0, T.default)({}, r.edges)),
          (this.startOffset = he(r.rect, e)),
          (this.startDelta = { x: 0, y: 0 });
        var o = this.fillArg({ phase: n, pageCoords: e, preEnd: !1 });
        return (
          (this.result = ve()), this.startAll(o), (this.result = this.setAll(o))
        );
      }),
      ...
      (e.setAll = function (t) {
        var e = t.phase,
          ...
          r = t.skipModifiers,
          i = t.rect;
        (t.coords = (0, T.default)({}, t.pageCoords)),
          (t.rect = (0, T.default)({}, i));
        for (
          var o = r ? this.states.slice(r) : this.states,
            a = ve(t.coords, t.rect),
            s = 0;
          s < o.length;
          s++
        ) {
          ...
          null != (l = c.methods) &&
            ...
            ((t.state = c),
            (f = c.methods.set(t)),
            I.addEdges(this.interaction.edges, t.rect, {
              x: t.coords.x - d.x,
              y: t.coords.y - d.y,
            })),
            a.eventProps.push(f);
        ...
        if (p && v) {
          var h =
            a.rect.left !== v.left ||
            a.rect.right !== v.right ||
            a.rect.top !== v.top ||
            a.rect.bottom !== v.bottom;
      ...
      (e.copyFrom = function (t) {
        (this.startOffset = t.startOffset),
          ...
          (this.result = ve(
            (0, T.default)({}, t.result.coords),
            (0, T.default)({}, t.result.rect)
          ));
      }),
      (e.destroy = function () {
  ...
  var _e = (function (t) {
    ...
    function r(e, n, r, i, o, a, s) {
      var l;
      ((l = t.call(this, e) || this).target = void 0),
      ...
      var c = e.interactable,
        ...
        h = f
          ...
          : e.coords.cur;
      return (
        (l.page = (0, T.default)({}, h.page)),
        (l.client = (0, T.default)({}, h.client)),
        (l.rect = (0, T.default)({}, e.rect)),
        ...
        (l.type = s || r + (i || '')),
        (l.interactable = c),
        (l.t0 = f ? e.pointers[e.pointers.length - 1].downTime : v.t0),
        (l.x0 = e.coords.start.page.x - d.x),
        (l.y0 = e.coords.start.page.y - d.y),
        (l.clientX0 = e.coords.start.client.x - d.x),
        (l.clientY0 = e.coords.start.client.y - d.y),
        (l.delta =
          f || p ? { x: 0, y: 0 } : { x: l[u].x - v[u].x, y: l[u].y - v[u].y }),
        (l.dt = e.coords.delta.timeStamp),
        (l.duration = l.timeStamp - l.t0),
        (l.velocity = (0, T.default)({}, e.coords.velocity[u])),
        (l.speed = (0, C.default)(l.velocity.x, l.velocity.y)),
        (l.swipe = p || 'inertiastart' === i ? l.getSwipe() : null),
        l
      );
    }
    (n = t),
  ...
  Object.defineProperty(we, '__esModule', { value: !0 }),
    (we.PointerInfo = void 0),
    (we.PointerInfo = function (t, e, n, r, i) {
      (this.id = void 0),
        (this.pointer = void 0),
        (this.event = void 0),
    ...
    Te = (function () {
      ...
      function n(t) {
        ...
        (this.interactable = null),
          ...
          (this.doMove = (0, It.warnOnce)(function (t) {
            this.move(t);
      ...
      return (
        ...
        (r.start = function (t, e, n) {
          return (
            ...
            ((0, It.copyAction)(this.prepared, t),
            (this.interactable = e),
            (this.element = n),
            (this.rect = e.getRect(n)),
            (this.edges = this.prepared.edges
              ? (0, T.default)({}, this.prepared.edges)
        ...
        (r.pointerMove = function (t, e, n) {
          ...
          this.pointerIsDown &&
            ...
            (this.pointerWasMoved =
              (0, C.default)(r, i) > this.pointerMoveTolerance));
          ...
          o || X.setCoordVelocity(this.coords.velocity, this.coords.delta),
        ...
        (r.move = function (t) {
          (t && t.event) || X.setZeroCoords(this.coords.delta),
            ((t = (0, T.default)(
              {
        ...
        (r.getPointerIndex = function (t) {
          ...
          return 'mouse' === this.pointerType || 'pen' === this.pointerType
            ...
            : G.findIndex(this.pointers, function (t) {
                return t.id === e;
              });
        }),
        ...
        (r.updatePointer = function (t, e, n, r) {
          ...
          return (
            ...
            a
              ? (a.pointer = t)
              : ((a = new we.PointerInfo(i, t, e, null, null)),
            ...
            r &&
              ...
              (a.downTarget = n),
              X.pointerExtend(this.downPointer, t),
              this.interacting() ||
                (X.copyCoords(this.coords.start, this.coords.cur),
                X.copyCoords(this.coords.prev, this.coords.cur),
                (this.downEvent = e),
                (this.pointerWasMoved = !1))),
        ...
        (r._doPhase = function (t) {
          ...
          if (
            ...
            !1 === this._scopeFire('interactions:before-action-' + n, t))
          )
            return !1;
          ...
          return (
            ...
            this._fireEvent(a),
            this._scopeFire('interactions:after-action-' + n, t),
            !0
          );
        }),
        (r._now = function () {
  ...
  function je(t) {
    t.pointerIsDown &&
      (ke(t.coords.cur, t.offset.total),
  ...
  var Re = {
    ...
    listeners: {
      ...
      'interactions:before-action-end': function (t) {
        var e = t.interaction;
        if (Ae(e)) return e.move({ offset: !0 }), e.end(), !1;
      },
      'interactions:stop': function (t) {
        var e = t.interaction;
        (e.offset.total.x = 0),
    ...
    return (
      (e.start = function (t) {
        ...
        if (
          ...
          if (((o.result = o.setAll(this.modifierArg)), !o.result.changed))
            return !1;
          this.startSmoothEnd();
        }
        return (
      ...
      (e.resume = function (t) {
        ...
        i.offsetBy({ x: -this.currentOffset.x, y: -this.currentOffset.y }),
          ...
          (0, X.copyCoords)(i.coords.prev, i.coords.cur),
          this.stop();
      }),
      (e.end = function () {
      ...
      (e.stop = function () {
        (this.active = this.smoothEnd = !1),
          ...
          bt.default.cancel(this.timeout);
      }),
      t
    );
  })();
  ...
  var Le = {
    ...
    install: function (t) {
      var e = t.defaults;
      t.usePlugin(De.default),
        t.usePlugin(ge.default),
  ...
  var qe = (function () {
    ...
    return (
      (e.fire = function (t) {
        var e,
          n = this.global;
        (e = this.types[t.type]) && Ve(t, e),
          !t.propagationStopped && n && (e = n[t.type]) && Ve(t, e);
      }),
      (e.on = function (t, e) {
  ...
  var $e = (function () {
    ...
    function r(t, n, r, i) {
      (this.options = void 0),
        ...
        (this._win = (0, e.getWindow)(
          (0, _.trySelector)(t) ? this._context : t
        )),
    ...
    var i = r.prototype;
    return (
      (i.setOnEvents = function (t, e) {
        return (
          o.default.func(e.onstart) && this.on(t + 'start', e.onstart),
          o.default.func(e.onmove) && this.on(t + 'move', e.onmove),
          o.default.func(e.onend) && this.on(t + 'end', e.onend),
          o.default.func(e.oninertiastart) &&
            this.on(t + 'inertiastart', e.oninertiastart),
          this
        );
      }),
        ...
        for (var r in e) {
          ...
          'listeners' === i && this.updatePerActionListeners(t, a.listeners, s),
            o.default.array(s)
              ...
              ? ((a[i] = (0, T.default)(a[i] || {}, (0, de.default)(s))),
      ...
      (i.getRect = function (t) {
        return (
          (t = t || (o.default.element(this.target) ? this.target : null)),
        ...
        return o.default.func(t)
          ? ((this._rectChecker = t),
            (this.getRect = function (t) {
              ...
              return (
                'width' in n ||
                  ((n.width = n.right - n.left), (n.height = n.bottom - n.top)),
                n
              );
            }),
            this)
        ...
        return (
          ...
          (!!o.default.element(n) &&
            (o.default.string(t)
              ...
              : !!o.default.element(t) && (0, _.nodeContains)(t, n)))
        );
      }),
      ...
      (i._onOff = function (t, e, n, r) {
        ...
        for (var s in a) {
          ...
          for (var l = 0; l < a[s].length; l++) {
            var c = a[s][l];
            (0, Ue.default)(s, this._actions)
              ? this.events[t](s, c)
              : o.default.string(this.target)
              ? this._scopeEvents[i + 'Delegate'](
                  this.target,
                  this._context,
                  s,
                  c,
              ...
              : this._scopeEvents[i](this.target, s, c, r);
          }
        }
        return this;
      }),
      ...
      (i.set = function (t) {
        ...
        (this.options = (0, de.default)(e.base)),
        this._actions.methodDict)) {
          ...
          (this.options[r] = {}),
            this.setPerAction(
              r,
              (0, T.default)((0, T.default)({}, e.perAction), e.actions[r])
            ),
            this[i](t[r]);
        }
  ...
  var Ze = (function () {
    ...
    return (
      (e.new = function (t, e) {
        e = (0, T.default)(e || {}, { actions: this.scope.actions });
        ...
        for (var n = 0; n < this.list.length; n++) {
          ...
          if (
            ((o.default.string(r.target)
              ? o.default.element(t) && _.matchesSelector(t, r.target)
              : t === r.target) &&
              r.inContext(t) &&
              (i = e(r)),
            void 0 !== i)
  ...
  var Qe = (function () {
    ...
    var e = t.prototype;
    return (
      (e.preventOriginalDefault = function () {
                ...
                if (p.selector === t && p.context === e) {
                  for (var v = p.listeners, h = v.length - 1; h >= 0; h--) {
                    ...
                    if (m === i && b === u.capture && x === u.passive) {
                      v.splice(h, 1),
                        v.length ||
                          (d.splice(a, 1), s(e, r, l), s(e, r, c, !0)),
                        (f = !0);
                      break;
                    }
                  }
              ...
              for (var p = 0; p < d.length; p++)
                if (d[p] === r) {
                  t.removeEventListener(
                    ...
                    d.splice(p, 1),
                    0 === d.length && (delete c.events[n], (u = !0));
                  break;
                }
            }
  ...
  Object.defineProperty(nn, '__esModule', { value: !0 }),
    (nn.createInteractStatic = function (t) {
      var e = function e(n, r) {
        ...
        return (
          i || ((i = t.interactables.new(n, r)).events.global = e.globalEvents),
          i
        );
      };
      return (
        (e.getPointerAverage = X.pointerAverage),
        (e.getTouchBBox = X.touchBBox),
        (e.getTouchDistance = X.touchDistance),
        (e.getTouchAngle = X.touchAngle),
        ...
        (e.on = (0, It.warnOnce)(function (t, e, n) {
          ...
          return (
            (0, Ue.default)(t, this.scope.actions)
              ? this.globalEvents[t]
        ...
        (e.off = (0, It.warnOnce)(function (t, e, n) {
          if (
            (o.default.string(t) &&
              -1 !== t.search(' ') &&
              (t = t.trim().split(/ +/)),
  ...
  var on = {
    ...
    mouseOrPen: function (t) {
      ...
      for (var l = 0; l < o.interactions.list.length; l++) {
        ...
        if (!(c.pointerType !== r || (/down/i.test(i) && c.simulation)))
          return c;
      }
      return null;
    },
  ...
  function fn(t) {
    var e = t.pointerType,
      n = t.scope,
      r = { interaction: rn.default.search(t), searchDetails: t };
    return (
  ...
  function pn(t, e) {
    var n = t.doc,
      ...
      a = r.events,
      s = a[e];
    for (var l in (r.browser.isIOS && !i.events && (i.events = { passive: !1 }),
    a.delegatedEvents))
  ...
  var mn = (function () {
    function t() {
      var t = this;
      (this.id = '__interact_scope_' + Math.floor(100 * Math.random())),
        (this.isInitialized = !1),
        (this.listenerMaps = []),
        (this.browser = y.default),
        (this.defaults = (0, de.default)(be.defaults)),
        (this.Eventable = Ne.Eventable),
        (this.actions = {
          map: {},
        ...
        (this.interactStatic = (0, nn.createInteractStatic)(this)),
        (this.InteractEvent = xe.InteractEvent),
        (this.Interactable = void 0),
        (this.interactables = new Ke.InteractableSet(this)),
        (this._win = void 0),
      ...
      this.Interactable = (function (t) {
        ...
        return (
          (s.set = function (n) {
            return (
              t.prototype.set.call(this, n),
              e.fire('interactable:set', { options: n, interactable: this }),
              this
            );
          }),
          (s.unset = function () {
            t.prototype.unset.call(this),
              e.interactables.list.splice(
                e.interactables.list.indexOf(this),
                1
              ),
              e.fire('interactable:unset', { interactable: this });
          }),
          (o = i),
          (a = [
            {
  ...
  (xn.init = Pn), 'object' == typeof window && window && Pn(window);
  var En = {};
        ...
        n = function (n, r) {
          for (
            var i = t.range,
              ...
              c = { range: i, grid: t, x: null, y: null },
              u = 0;
            u < e.length;
            u++
          ) {
            var d = e[u],
              f = d[0],
              p = d[1],
              v = Math.round((n - l.x) / t[f]),
              h = Math.round((r - l.y) / t[p]);
            (c[f] = Math.max(a.left, Math.min(a.right, v * t[f] + l.x))),
              (c[p] = Math.max(a.top, Math.min(a.bottom, h * t[p] + l.y)));
          }
          return c;
        };
  ...
  var In = {
    ...
    install: function (t) {
      var e = t.interactStatic;
      (e.snappers = (0, T.default)(e.snappers || {}, On)),
  ...
  var zn = {
    start: function (t) {
      ...
      'preserve' === o && (o = n.width / n.height),
        (e.startCoords = (0, T.default)({}, i)),
        (e.startRect = (0, T.default)({}, n)),
        (e.ratio = o),
        (e.equalDelta = s);
      var c = (e.linkedEdges = {
      ...
      if (((e.xIsPrimaryAxis = !(!r.left && !r.right)), e.equalDelta))
        e.edgeSign = (c.left ? 1 : -1) * (c.top ? 1 : -1);
      else {
      ...
      if (((0, T.default)(t.edges, c), l && l.length)) {
        ...
        d.copyFrom(t.interaction.modification),
          d.prepareStates(l),
          (e.subModification = d),
          d.startAll(jn({}, t));
      }
    ...
    set: function (t) {
      ...
      var a = (0, T.default)({}, n);
      (0, I.addEdges)(e.linkedEdges, a, { x: r.x - i.x, y: r.y - i.y });
      ...
      return (
        s.changed &&
          (o(e, Math.abs(l.x) > Math.abs(l.y), s.coords, s.rect),
          (0, T.default)(r, s.coords)),
        s.eventProps
      );
    },
  ...
  function Bn(t, e, n) {
    return o.default.func(t)
      ? I.resolveRectLike(t, e.interactable, e.element, [n.x, n.y, e])
      : I.resolveRectLike(t, e.interactable, e.element);
  }
  Object.defineProperty(Wn, '__esModule', { value: !0 }),
    (Wn.getRestrictionRect = Bn),
    (Wn.restrict = Wn.default = void 0);
  var Ln = {
    start: function (t) {
      var e = t.rect,
        n = t.startOffset,
      ...
      if (e && s) {
        ...
        if (c) {
          ...
          u < 0 && ((l.left += u), (l.right += u)),
            d < 0 && ((l.top += d), (l.bottom += d));
        }
  ...
  var qn = { top: 1 / 0, left: 1 / 0, bottom: -1 / 0, right: -1 / 0 },
    Un = { top: -1 / 0, left: -1 / 0, bottom: 1 / 0, right: 1 / 0 };
  function Gn(t, e) {
    ...
    set: function (t) {
      ...
      if (n) {
        ...
        Gn(l, qn),
          Gn(c, Un),
          n.top
            ? (e.y = Math.min(Math.max(c.top + o.top, s.y), l.top + o.top))
            : n.bottom &&
              (e.y = Math.max(
                Math.min(c.bottom + o.bottom, s.y),
                l.bottom + o.bottom
              )),
          n.left
            ? (e.x = Math.min(Math.max(c.left + o.left, s.x), l.left + o.left))
            : n.right &&
              (e.x = Math.max(
                Math.min(c.right + o.right, s.x),
                l.right + o.right
              ));
      }
    },
  ...
  var Zn = (0, T.default)(
    ...
    Jn = { start: Wn.restrict.start, set: Wn.restrict.set, defaults: Zn };
  Kn.restrictRect = Jn;
  ...
  var er = { width: -1 / 0, height: -1 / 0 },
    nr = { width: 1 / 0, height: 1 / 0 },
    rr = {
      start: function (t) {
      ...
      set: function (t) {
        ...
        if (i) {
          var a =
              I.tlbrToXywh((0, Wn.getRestrictionRect)(o.min, e, t.coords)) ||
              er,
            s =
              I.tlbrToXywh((0, Wn.getRestrictionRect)(o.max, e, t.coords)) ||
              nr;
          (n.options = {
            endOnly: o.endOnly,
  ...
  var sr = {
    start: function (t) {
      var e,
        ...
        s = t.startOffset,
        l = a.options,
        c = l.offsetWithOrigin
          ? (function (t) {
              var e = t.interaction.element;
              return (
                (0, I.rectToXY)(
                  (0, I.resolveRectLike)(t.state.options.origin, null, null, [
                    e,
                  ])
                ) ||
                (0, j.default)(t.interactable, e, t.interaction.prepared.name)
              );
            })(t)
          : { x: 0, y: 0 };
    ...
    set: function (t) {
      ...
      for (var u = 0; u < a.length; u++)
        for (
          ...
          var g,
            m = i.targets[v];
          (g = o.default.func(m) ? m(f, p, e._proxy, d, v) : m) &&
            c.push({
      ...
      for (
        ...
        var x = c[b],
          ...
          E = (0, C.default)(w, P),
          S = E <= _;
        _ === 1 / 0 && y.inRange && y.range !== 1 / 0 && (S = !1),
          (y.target &&
            !(S
              ? y.inRange && _ !== 1 / 0
                ? E / _ < y.distance / y.range
                : (_ === 1 / 0 && y.range !== 1 / 0) || E < y.distance
              : !y.inRange && E < y.distance)) ||
            ((y.target = x),
            (y.distance = E),
            (y.range = _),
            (y.inRange = S),
  ...
  var xr = {
    ...
    install: function (t) {
      var e = t.interactStatic;
      for (var n in (t.usePlugin(ge.default),
      t.usePlugin(Tn.default),
      (e.modifiers = mr.default),
      mr.default)) {
        var r = mr.default[n],
          i = r._defaults,
          o = r._methods;
  ...
  var Er = (function (t) {
    ...
    function r(e, n, r, i, o, a) {
      var s;
      if (
        (((s = t.call(this, o) || this).type = void 0),
        (s.originalEvent = void 0),
        (s.pointerId = void 0),
        (s.pointerType = void 0),
        (s.double = void 0),
        (s.pageX = void 0),
        (s.pageY = void 0),
        (s.clientX = void 0),
        ...
        (s.dt = void 0),
        (s.eventable = void 0),
        X.pointerExtend(Pr(s), r),
        r !== n && X.pointerExtend(Pr(s), n),
        (s.timeStamp = a),
        (s.originalEvent = r),
        (s.type = e),
        (s.pointerId = X.getPointerId(n)),
        (s.pointerType = X.getPointerType(n)),
        (s.target = i),
        ...
        s.double = !!(
          o.prevTap &&
          'doubletap' !== o.prevTap.type &&
          o.prevTap.target === s.target &&
          c < 500
        );
  ...
  var Mr = {
    ...
    install: function (t) {
      (t.pointerEvents = Mr),
        (t.defaults.actions.pointerEvents = Mr.defaults),
        (0, T.default)(t.actions.phaselessTypes, Mr.types);
    },
    listeners: {
      'interactions:new': function (t) {
        var e = t.interaction;
  ...
  function Or(t, e) {
    ...
    for (
      ...
      if (
        (c._subtractOrigin(v),
        (c.eventable = f.eventable),
        (c.currentTarget = f.node),
        f.eventable.fire(c),
        c._addOrigin(v),
        c.immediatePropagationStopped ||
          (c.propagationStopped &&
            d + 1 < l.length &&
            l[d + 1].node !== c.currentTarget))
      )
        break;
    }
  ...
  function Tr(t, e) {
    var n = t.interaction,
      ...
      l = n.pointers[s];
    if ('tap' === a && (n.pointerWasMoved || !l || l.downTarget !== o))
      return [];
    for (
      var c = _.getPath(o),
        u = {
      ...
      'hold' === a &&
        (u.targets = u.targets.filter(function (t) {
          ...
          return (
            ...
            (null == (e = n.pointers[s]) ? void 0 : e.hold.duration)
          );
        })),
      u.targets
    );
  ...
  Object.defineProperty(jr, '__esModule', { value: !0 }), (jr.default = void 0);
  var Ar = {
  ...
  var Rr = {
    ...
    listeners: {
      ...
      'interactable:set': function (t, e) {
        var n = t.interactable,
          r = t.options;
        (0, T.default)(n.events.options, e.pointerEvents.defaults),
          (0, T.default)(n.events.options, r.pointerEvents || {});
      },
    },
  };
  Cr.default = Rr;
        ...
        return (function (t, e, n) {
          for (
            var r = o.default.string(t.target)
                ? G.from(t._context.querySelectorAll(t.target))
                : [t.target],
              i = n.window.Promise,
              a = i ? [] : null,
              s = function () {
                ...
                if (c)
                  ...
                  u = (function (t, e, n, r, i) {
                    ...
                    (o.interactable = e),
                      ...
                      X.setZeroCoords(o.coords.delta),
                      (0, It.copyAction)(o.prepared, r),
                      o._doPhase(a);
    ...
    listeners: {
      'interactions:stop': function (t, e) {
        ...
        'reflow' === n.pointerType &&
          ...
          G.remove(e.interactions.list, n));
      },
    },
  };
  Wr.default = Lr;
  ...
  Object.defineProperty(Nr, '__esModule', { value: !0 }),
    ...
    (Nr.default = {});
  var Vr = { exports: {} };
  Object.defineProperty(Vr.exports, '__esModule', { value: !0 }),
    (Vr.exports.default = void 0),
    xn.default.use(_r.default),
    xn.default.use(Jt.default),
    xn.default.use(De.default),
    xn.default.use(Zt.default),
    xn.default.use(yt.default),
    xn.default.use(Fr.default),
    xn.default.use(Fe.default),
    xn.default.use(br.default),
    xn.default.use($t.default),
    xn.default.use(gt.default),
    xn.default.use(Et.default),
    xn.default.use(Wr.default),
    xn.default.use(ue.default),
    xn.default.use(Nr.default),
    xn.default.use(Yr.default),
    xn.default.use(ie.default);
  var qr = xn.default;
  ...
  var Ur = { exports: {} };
  Object.defineProperty(Ur.exports, '__esModule', { value: !0 }),
